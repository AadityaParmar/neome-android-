...
data class DtoEntSpreadsheetData(
    ...
    override val forwardRoleIdSet: List<@Serializable(with = MetaIdRoleSer::class) Types.MetaIdRole>,
    override val hasPartition: Boolean,
    override val insertRoleIdSet: List<@Serializable(with = MetaIdRoleSer::class) Types.MetaIdRole>,
    override val label: String? = null,
    override val layoutMap: DefnLayoutGridMapData? = null,
    @Serializable(with = SymbolSer::class) override val name: Symbol,
    override val removeRoleIdSet: List<@Serializable(with = MetaIdRoleSer::class) Types.MetaIdRole>,
    ...
    override val updateRoleIdSet: List<@Serializable(with = MetaIdRoleSer::class) Types.MetaIdRole>
) : DtoEntSpreadsheet
