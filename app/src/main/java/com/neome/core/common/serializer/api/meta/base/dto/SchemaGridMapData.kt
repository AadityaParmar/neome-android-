...
import com.neome.core.common.serializer.api.meta.base.dto.SchemaGridData
...
data class SchemaGridMapData(
    override val map: Map<@Serializable(with = MetaIdGridSer::class) Types.MetaIdGrid, SchemaGridData>
) : SchemaGridMap
