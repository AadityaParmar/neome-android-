...
import com.neome.api.meta.base.dto.DefnFieldMonth
...
@Serializable
sealed interface DefnFieldMonthSeal : DefnFieldMonth


@Serializable
data class DefnFieldMonthData(
    ...
    override val defaultValue: EnumDefnMonth? = null,
    override val defaultVar: EnumDefnMonth? = null
) : DefnCompSeal, DefnFieldMonth
