...
import com.neome.api.meta.base.dto.StudioFieldHandle
...
@Serializable
data class StudioFieldHandleData(
    ...
    override val autoPickSelf: Boolean? = null,
    ...
    @Serializable(with = MetaIdVarSer::class) override val invalidDomainVarId: Types.MetaIdVar? = null,
    @Serializable(with = MetaIdVarSer::class) override val invalidMobileCountryCodeSetVarId: Types.MetaIdVar? = null,
    @Serializable(with = MetaIdVarSer::class) override val validDomainVarId: Types.MetaIdVar? = null,
    @Serializable(with = MetaIdVarSer::class) override val validMobileCountryCodeSetVarId: Types.MetaIdVar? = null
) : StudioFieldHandle
