...
data class StudioMapOfSwimlaneData(
    override val keys: Array<@Serializable(with = MetaIdSwimlaneSer::class) Types.MetaIdSwimlane>? = null,
    override val map: Map<@Serializable(with = MetaIdSwimlaneSer::class) Types.MetaIdSwimlane, StudioDtoSwimlane>
) : StudioMapOfSwimlane
