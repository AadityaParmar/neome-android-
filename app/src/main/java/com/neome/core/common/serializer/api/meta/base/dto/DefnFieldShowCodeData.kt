...
@Serializable
sealed interface DefnFieldShowCodeSeal : DefnFieldShowCode


@Serializable
data class DefnFieldShowCodeData(
    ...
    override val codeType: EnumDefnCodeType? = null,
    ...
    override val showLabelVar: Boolean? = null
) : DefnCompSeal, DefnFieldShowCode
