...
data class StudioPluginMapData(
    override val keys: List<@Serializable(with = PluginIdSer::class) Types.PluginId>,
    override val map: Map<@Serializable(with = PluginIdSer::class) Types.PluginId, StudioPluginData>
) : StudioPluginMap
