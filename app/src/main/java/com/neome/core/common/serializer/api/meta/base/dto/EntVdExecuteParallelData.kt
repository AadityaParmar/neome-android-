...
import com.neome.api.meta.base.dto.EntVdExecuteParallel
...
import com.neome.core.common.serializer.api.meta.base.dto.EntVdWorkflowControlMapData
...
@Serializable
data class EntVdExecuteParallelData(
    ...
    override val responseWaitKind: EnumDefnKindAutoResponseWait? = null,
    override val workflowControlMap: EntVdWorkflowControlMapData? = null
) : EntVdExecuteParallel
