...
import com.neome.api.meta.base.dto.DefnFieldLogNumber
...
@Serializable
sealed interface DefnFieldLogNumberSeal : DefnFieldLogNumber


@Serializable
data class DefnFieldLogNumberData(
...
) : DefnCompSeal, DefnFieldLogNumber
