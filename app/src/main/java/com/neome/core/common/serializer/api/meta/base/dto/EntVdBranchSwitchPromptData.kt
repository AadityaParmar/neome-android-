...
import com.neome.api.meta.base.dto.EntVdBranchSwitchPrompt
...
import com.neome.core.common.serializer.api.meta.base.dto.EntVdPromptMapData
...
@Serializable
data class EntVdBranchSwitchPromptData(
    ...
    override val field: StudioDtoArgValueParameterData? = null,
    override val promptMap: EntVdPromptMapData? = null
) : EntVdBranchSwitchPrompt
