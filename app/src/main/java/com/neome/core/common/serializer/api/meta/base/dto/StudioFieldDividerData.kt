...
import com.neome.api.meta.base.dto.StudioFieldDivider
...
@Serializable
data class StudioFieldDividerData(
    ...
    @Serializable(with = MetaIdVarSer::class) override val dividerKindVarId: Types.MetaIdVar? = null
) : StudioFieldDivider
