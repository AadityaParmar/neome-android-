...
import com.neome.api.meta.base.dto.DefnFieldTextSize
...
@Serializable
sealed interface DefnFieldTextSizeSeal : DefnFieldTextSize


@Serializable
data class DefnFieldTextSizeData(
    ...
    override val defaultValue: EnumDefnTextSize? = null,
    override val defaultVar: EnumDefnTextSize? = null
) : DefnCompSeal, DefnFieldTextSize
