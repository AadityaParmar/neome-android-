...
data class DefnStudioBuildArgBinderData(
    ...
    override val derivedCompositeIdSet: Array<@Serializable(with = MetaIdCompositeSer::class) Types.MetaIdComposite>? = null,
    ...
    override val excludeVarIdSet: Array<@Serializable(with = MetaIdVarSer::class) Types.MetaIdVar>? = null,
    override val filterConstantFieldTypeSet: Array<EnumDefnCompType>? = null,
    override val filterContextCallerSet: Array<String>? = null,
    override val filterContextCallerSettingSet: Array<String>? = null,
    override val filterContextEntSet: Array<String>? = null,
    override val filterContextOptionSet: Array<String>? = null,
    override val filterContextRowSet: Array<String>? = null,
    override val filterDerivedFieldTypeSet: Array<EnumDefnCompType>? = null,
    override val filterFieldTypeSet: Array<EnumDefnCompType>? = null,
    override val filterKindSet: Array<EnumDefnArgBinder>? = null,
    override val filterVarKindSet: Array<EnumStudioVarKind>? = null,
