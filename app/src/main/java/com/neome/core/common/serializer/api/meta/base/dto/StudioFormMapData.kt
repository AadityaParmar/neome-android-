...
data class StudioFormMapData(
    override val keys: List<@Serializable(with = MetaIdFormSer::class) Types.MetaIdForm>,
    override val map: Map<@Serializable(with = MetaIdFormSer::class) Types.MetaIdForm, StudioFormData>
) : StudioFormMap
