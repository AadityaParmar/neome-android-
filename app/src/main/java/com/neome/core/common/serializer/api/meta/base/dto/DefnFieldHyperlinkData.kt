...
@Serializable
sealed interface DefnFieldHyperlinkSeal : DefnFieldHyperlink


@Serializable
data class DefnFieldHyperlinkData(
    ...
    override val defaultVar: DefnDtoHyperLinkData? = null
) : DefnCompSeal, DefnFieldHyperlink
