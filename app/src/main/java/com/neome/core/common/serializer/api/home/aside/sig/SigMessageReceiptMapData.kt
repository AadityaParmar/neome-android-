...
import com.neome.core.common.serializer.api.home.base.dto.DtoReceiptData
...
data class SigMessageReceiptMapData(
    override val entUserReceiptMap: Map<@Serializable(with = EntUserIdSer::class) Types.EntUserId, DtoReceiptData>
