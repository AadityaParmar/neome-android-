...
import com.neome.api.meta.base.dto.StudioEntAutomationStepGetSpreadsheetRow
...
@Serializable
data class StudioEntAutomationStepGetSpreadsheetRowData(
    ...
    @Serializable(with = MetaIdFieldSer::class) override val rowIdFieldId: Types.MetaIdField? = null,
...
) : StudioEntAutomationStepGetSpreadsheetRow
