...
import com.neome.api.meta.base.dto.DefnStudioVarIdTextEditor
...
@Serializable
sealed interface DefnStudioVarIdTextEditorSeal : DefnStudioVarIdTextEditor


@Serializable
data class DefnStudioVarIdTextEditorData(
    ...
    override val argBinderFilterVarKindSet: Array<EnumStudioVarKind>? = null,
    @Serializable(with = MetaIdFormSer::class) override val argBinderFormId: Types.MetaIdForm? = null,
    ...
    override val showAsEdit: Boolean? = null
) : DefnCompSeal, DefnStudioVarIdTextEditor
