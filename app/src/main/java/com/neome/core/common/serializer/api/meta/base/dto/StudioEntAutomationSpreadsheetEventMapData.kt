...
import com.neome.core.common.serializer.api.meta.base.dto.StudioEntAutomationSpreadsheetEventData
...
data class StudioEntAutomationSpreadsheetEventMapData(
    ...
    override val map: Map<@Serializable(with = MetaIdEventSer::class) Types.MetaIdEvent, StudioEntAutomationSpreadsheetEventData>
