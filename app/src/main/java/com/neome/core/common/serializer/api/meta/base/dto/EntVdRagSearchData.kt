...
import com.neome.api.meta.base.dto.EntVdRagSearch
...
data class EntVdRagSearchData(
    ...
    override val maxResultCount: Long? = null,
    override val searchSpreadsheetIdSet: List<@Serializable(with = MetaIdSpreadsheetSer::class) Types.MetaIdSpreadsheet>? = null,
    override val searchText: StudioBuildArgBinderData? = null,
    override val ragGroupField: StudioDtoArgValueParameterData? = null
) : EntVdRagSearch
