...
import com.neome.api.meta.base.dto.StudioFieldMobileNumber
...
@Serializable
data class StudioFieldMobileNumberData(
    ...
    @Serializable(with = MetaIdVarSer::class) override val invalidCountryCodeSetVarId: Types.MetaIdVar? = null,
    @Serializable(with = MetaIdVarSer::class) override val validCountryCodeSetVarId: Types.MetaIdVar? = null
) : StudioFieldMobileNumber
