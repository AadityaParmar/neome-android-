...
import com.neome.core.common.serializer.api.meta.base.dto.StudioVisibilityActionMapData
...
data class StudioVisibilityRuleData(
    override val actionMapIfFalse: StudioVisibilityActionMapData,
    override val actionMapIfTrue: StudioVisibilityActionMapData,
    override val description: String? = null,
    @Serializable(with = MetaIdVisibilityRuleSer::class) override val metaId: Types.MetaIdVisibilityRule,
    @Serializable(with = SymbolSer::class) override val name: Symbol,
    override val visibilityCondMap: StudioMapOfVisibilityConditionData? = null
