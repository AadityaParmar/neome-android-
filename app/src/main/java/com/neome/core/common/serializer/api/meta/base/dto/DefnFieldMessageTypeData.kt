...
import com.neome.api.meta.base.dto.DefnFieldMessageType
...
@Serializable
sealed interface DefnFieldMessageTypeSeal : DefnFieldMessageType


@Serializable
data class DefnFieldMessageTypeData(
...
) : DefnCompSeal, DefnFieldMessageType
