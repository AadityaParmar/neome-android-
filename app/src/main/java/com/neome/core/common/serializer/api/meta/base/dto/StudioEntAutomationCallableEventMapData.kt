...
import com.neome.core.common.serializer.api.meta.base.dto.StudioEntAutomationCallableEventData
...
data class StudioEntAutomationCallableEventMapData(
    ...
    override val map: Map<@Serializable(with = MetaIdEventSer::class) Types.MetaIdEvent, StudioEntAutomationCallableEventData>
