...
import com.neome.api.meta.base.dto.DefnStudioBuildOptionPermissionMatrix
...
@Serializable
sealed interface DefnStudioBuildOptionPermissionMatrixSeal : DefnStudioBuildOptionPermissionMatrix


@Serializable
data class DefnStudioBuildOptionPermissionMatrixData(
    ...
    override val optionSet: List<DefnDtoOptionData>? = null
) : DefnCompSeal, DefnStudioBuildOptionPermissionMatrix
