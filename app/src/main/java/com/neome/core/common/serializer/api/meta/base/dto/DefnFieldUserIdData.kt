...
import com.neome.api.meta.base.dto.DefnFieldUserId
...
@Serializable
sealed interface DefnFieldUserIdSeal : DefnFieldUserId


@Serializable
data class DefnFieldUserIdData(
    ...
    override val defaultValue: EnumDefnRowProperty? = null,
    override val displayProperty: EnumDefnUserProperty? = null
) : DefnCompSeal, DefnFieldUserId
