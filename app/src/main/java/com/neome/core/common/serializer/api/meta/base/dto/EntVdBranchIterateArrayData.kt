...
import com.neome.api.meta.base.dto.EntVdBranchIterateArray
...
@Serializable
data class EntVdBranchIterateArrayData(
    ...
    @Serializable(with = MetaIdFieldSer::class) override val arrayField: Types.MetaIdField? = null
) : EntVdBranchIterateArray
