...
import com.neome.api.meta.base.dto.EntVdBotHistoryRemove
...
@Serializable
data class EntVdBotHistoryRemoveData(
    ...
    override val historyIdField: StudioDtoArgValueParameterData? = null,
    override val removeAll: Boolean? = null,
    override val retainCount: Long? = null
) : EntVdBotHistoryRemove
