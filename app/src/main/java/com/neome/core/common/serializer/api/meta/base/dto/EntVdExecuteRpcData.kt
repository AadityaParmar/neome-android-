...
import com.neome.api.meta.base.dto.EntVdExecuteRpc
...
@Serializable
data class EntVdExecuteRpcData(
    ...
    override val apiName: StudioValueTextData? = null,
    ...
    @Serializable(with = KeychainIdSer::class) override val sendKeychainId: Types.KeychainId? = null
) : EntVdExecuteRpc
