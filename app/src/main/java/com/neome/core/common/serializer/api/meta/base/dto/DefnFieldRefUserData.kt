...
import com.neome.api.meta.base.dto.DefnFieldRefUser
...
@Serializable
sealed interface DefnFieldRefUserSeal : DefnFieldRefUser


@Serializable
data class DefnFieldRefUserData(
    ...
    override val copyFieldVarMap: Map<@Serializable(with = MetaIdFieldSer::class) Types.MetaIdField, @Serializable(with = MetaIdVarSer::class) Types.MetaIdVar>? = null,
