...
import com.neome.api.meta.base.dto.DefnFieldLanguage
...
@Serializable
sealed interface DefnFieldLanguageSeal : DefnFieldLanguage


@Serializable
data class DefnFieldLanguageData(
    ...
    @Serializable(with = LanguageKeySer::class) override val defaultValue: Types.LanguageKey? = null,
    @Serializable(with = LanguageKeySer::class) override val defaultVar: Types.LanguageKey? = null
) : DefnCompSeal, DefnFieldLanguage
