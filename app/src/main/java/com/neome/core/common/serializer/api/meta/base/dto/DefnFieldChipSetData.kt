...
import com.neome.api.meta.base.dto.DefnFieldChipSet
...
@Serializable
sealed interface DefnFieldChipSetSeal : DefnFieldChipSet


@Serializable
data class DefnFieldChipSetData(
    ...
    override val allowDuplicate: Boolean? = null
) : DefnCompSeal, DefnFieldChipSet
