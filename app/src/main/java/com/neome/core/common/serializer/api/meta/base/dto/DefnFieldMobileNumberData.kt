...
@Serializable
sealed interface DefnFieldMobileNumberSeal : DefnFieldMobileNumber


@Serializable
data class DefnFieldMobileNumberData(
    ...
    override val invalidCountryCodeSetVar: Array<String>? = null,
    override val validCountryCodeSetVar: Array<String>? = null
) : DefnCompSeal, DefnFieldMobileNumber
