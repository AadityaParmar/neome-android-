...
@Serializable
sealed interface DefnFieldDateRangeSeal : DefnFieldDateRange


@Serializable
data class DefnFieldDateRangeData(
    ...
    override val defaultValue: DefnBuildDateData? = null,
    override val defaultVar: DefnBuildDateData? = null,
    override val displayDateFormat: String? = null,
    override val max: DefnBuildDateData? = null,
    @Serializable(with = MetaIdFieldSer::class) override val maxFieldId: Types.MetaIdField? = null,
    override val maxVar: DefnBuildDateData? = null,
    override val min: DefnBuildDateData? = null,
    @Serializable(with = MetaIdFieldSer::class) override val minFieldId: Types.MetaIdField? = null,
    override val minVar: DefnBuildDateData? = null,
    ...
    override val fromDefault: DefnBuildDateData? = null,
    @Serializable(with = MetaIdFieldSer::class) override val fromDefaultFieldId: Types.MetaIdField? = null,
    override val fromDefaultVar: DefnBuildDateData? = null,
    override val toDefault: DefnBuildDateData? = null,
    @Serializable(with = MetaIdFieldSer::class) override val toDefaultFieldId: Types.MetaIdField? = null,
    override val toDefaultVar: DefnBuildDateData? = null
) : DefnCompSeal, DefnFieldDateRange
