...
import com.neome.api.meta.base.dto.StudioEntAutomationSpreadsheetStepForwardToGroups
...
@Serializable
data class StudioEntAutomationSpreadsheetStepForwardToGroupsData(
    ...
    @Serializable(with = MetaIdPipelineParamSer::class) override val formDataSourcePipelineVarId: Types.MetaIdPipelineParam? = null,
