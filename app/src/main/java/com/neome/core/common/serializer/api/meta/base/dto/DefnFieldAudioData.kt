...
@Serializable
sealed interface DefnFieldAudioSeal : DefnFieldAudio


@Serializable
data class DefnFieldAudioData(
    ...
    override val audioFormatType: EnumDefnAudioFormat? = null,
