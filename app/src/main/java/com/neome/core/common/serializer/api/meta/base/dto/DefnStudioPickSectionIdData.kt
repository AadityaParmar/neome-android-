...
import com.neome.api.meta.base.dto.DefnStudioPickSectionId
...
@Serializable
sealed interface DefnStudioPickSectionIdSeal : DefnStudioPickSectionId


@Serializable
data class DefnStudioPickSectionIdData(
    ...
    override val excludeSectionIdSet: Array<@Serializable(with = MetaIdSectionSer::class) Types.MetaIdSection>? = null,
    @Serializable(with = MetaIdFormSer::class) override val formId: Types.MetaIdForm
) : DefnCompSeal, DefnStudioPickSectionId
