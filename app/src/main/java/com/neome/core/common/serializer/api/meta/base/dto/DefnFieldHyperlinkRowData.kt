...
import com.neome.api.meta.base.dto.DefnFieldHyperlinkRow
...
@Serializable
sealed interface DefnFieldHyperlinkRowSeal : DefnFieldHyperlinkRow


@Serializable
data class DefnFieldHyperlinkRowData(
    ...
    override val displayTextVar: DefnDtoTextData? = null,
    override val hyperlinkFieldIdSet: List<@Serializable(with = MetaIdFieldSer::class) Types.MetaIdField>? = null,
    @Serializable(with = MetaIdSpreadsheetSer::class) override val spreadsheetId: Types.MetaIdSpreadsheet? = null
) : DefnCompSeal, DefnFieldHyperlinkRow
