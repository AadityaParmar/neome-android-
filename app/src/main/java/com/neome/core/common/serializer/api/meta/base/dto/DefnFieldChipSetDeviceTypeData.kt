...
import com.neome.api.meta.base.dto.DefnFieldChipSetDeviceType
...
@Serializable
sealed interface DefnFieldChipSetDeviceTypeSeal : DefnFieldChipSetDeviceType


@Serializable
data class DefnFieldChipSetDeviceTypeData(
    ...
    override val defaultValue: Array<EnumDeviceType>? = null,
    override val defaultVar: EnumDeviceType? = null
) : DefnCompSeal, DefnFieldChipSetDeviceType
