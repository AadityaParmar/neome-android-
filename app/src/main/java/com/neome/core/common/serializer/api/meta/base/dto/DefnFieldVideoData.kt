...
@Serializable
sealed interface DefnFieldVideoSeal : DefnFieldVideo


@Serializable
data class DefnFieldVideoData(
    ...
    override val allowPickVideo: Boolean? = null,
    ...
    override val showPreviewVar: Boolean? = null,
    ...
    override val videoFormatType: EnumDefnVideoFormat? = null
) : DefnCompSeal, DefnFieldVideo
