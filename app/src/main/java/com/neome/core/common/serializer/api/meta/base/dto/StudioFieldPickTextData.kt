...
import com.neome.api.meta.base.dto.StudioFieldPickText
...
import com.neome.core.common.serializer.api.meta.base.dto.StudioMapOfOptionData
import com.neome.core.common.serializer.api.meta.base.dto.StudioMapOfOptionPermissionData
...
@Serializable
data class StudioFieldPickTextData(
    ...
    @Serializable(with = MetaIdFieldSer::class) override val defaultOptionFieldId: Types.MetaIdField? = null,
    override val defaultOptionId: String? = null,
    override val optionPermissionMap: StudioMapOfOptionPermissionData? = null,
    ...
    override val source: StudioMapOfOptionData? = null,
    @Serializable(with = MetaIdFieldSer::class) override val sourceFieldId: Types.MetaIdField? = null,
