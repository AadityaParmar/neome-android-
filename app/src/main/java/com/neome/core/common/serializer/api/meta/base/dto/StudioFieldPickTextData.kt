...
data class StudioFieldPickTextData(
    ...
    override val optionPermissionMap: StudioMapOfOptionPermission? = null,
    override val pluginApi: StudioDtoPluginApi? = null,
    ...
    override val source: StudioMapOfOption? = null,
