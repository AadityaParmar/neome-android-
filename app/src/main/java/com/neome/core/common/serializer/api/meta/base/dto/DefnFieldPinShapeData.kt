...
import com.neome.api.meta.base.dto.DefnFieldPinShape
...
@Serializable
sealed interface DefnFieldPinShapeSeal : DefnFieldPinShape


@Serializable
data class DefnFieldPinShapeData(
    ...
    override val defaultValue: EnumDefnMapPinShape? = null,
    override val defaultVar: EnumDefnMapPinShape? = null
) : DefnCompSeal, DefnFieldPinShape
