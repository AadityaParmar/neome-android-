...
data class StudioEntPrivateStateData(
    ...
    override val refTokenSet: Array<String>? = null,
    ...
    override val spreadsheetRefTokenMap: Map<@Serializable(with = MetaIdSpreadsheetSer::class) Types.MetaIdSpreadsheet, StudioEntSpreadsheetRefTokenMap>? = null
