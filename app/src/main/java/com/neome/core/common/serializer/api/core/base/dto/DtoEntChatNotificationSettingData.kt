...
data class DtoEntChatNotificationSettingData(
    override val entNotificationSetting: DtoNotificationSettingData? = null,
    override val map: Map<@Serializable(with = ChatIdSer::class) Types.ChatId, DtoNotificationSettingData>? = null
