...
import com.neome.api.meta.base.dto.EntVdUserUpdate
...
@Serializable
data class EntVdUserUpdateData(
    ...
    override val userActivateField: StudioBuildArgBinderData? = null,
    override val userIdField: StudioDtoArgValueParameterData? = null,
