...
import com.neome.api.meta.base.dto.DefnFieldCurrency
...
@Serializable
sealed interface DefnFieldCurrencySeal : DefnFieldCurrency


@Serializable
data class DefnFieldCurrencyData(
    ...
    @Serializable(with = CurrencyKeySer::class) override val defaultValue: Types.CurrencyKey? = null,
    @Serializable(with = CurrencyKeySer::class) override val defaultVar: Types.CurrencyKey? = null
) : DefnCompSeal, DefnFieldCurrency
