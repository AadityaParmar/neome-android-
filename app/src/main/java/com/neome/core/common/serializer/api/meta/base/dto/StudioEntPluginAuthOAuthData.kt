...
import com.neome.api.meta.base.dto.StudioEntPluginAuthOAuth
...
@Serializable
data class StudioEntPluginAuthOAuthData(
    ...
    override val authEndPoint: StudioValueTextData,
    override val clientId: StudioValueTextData,
    override val clientSecret: StudioValueTextData,
    override val scopes: StudioValueTextData? = null,
    override val tokenEndPoint: StudioValueTextData
) : StudioEntPluginAuthOAuth
