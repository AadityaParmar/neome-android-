...
@Serializable
sealed interface DefnFieldLocationSeal : DefnFieldLocation


@Serializable
data class DefnFieldLocationData(
    ...
    override val captureMode: EnumDefnCaptureMode? = null,
    ...
    override val defaultValue: FieldDtoLocationData? = null,
    override val defaultVar: FieldDtoLocationData? = null,
    override val showCapturedValuesOnAside: List<EnumDefnCaptureValueKind>? = null,
    override val showProgressBar: Boolean? = null
) : DefnCompSeal, DefnFieldLocation
