...
@Serializable
sealed interface DefnFieldDividerSeal : DefnFieldDivider


@Serializable
data class DefnFieldDividerData(
    ...
    override val colorVar: EnumDefnThemeColor? = null,
    override val dividerKind: EnumDefnThemeDividerKind? = null,
    override val dividerKindVar: EnumDefnThemeDividerKind? = null,
    override val sectionDirection: EnumDefnThemeDirection? = null
) : DefnCompSeal, DefnFieldDivider
