...
import com.neome.api.meta.base.dto.DefnStudioBuildRefTargetSpreadsheet
...
@Serializable
sealed interface DefnStudioBuildRefTargetSpreadsheetSeal : DefnStudioBuildRefTargetSpreadsheet


@Serializable
data class DefnStudioBuildRefTargetSpreadsheetData(
    ...
    @Serializable(with = MetaIdFormSer::class) override val excludeFormId: Types.MetaIdForm? = null
) : DefnCompSeal, DefnStudioBuildRefTargetSpreadsheet
