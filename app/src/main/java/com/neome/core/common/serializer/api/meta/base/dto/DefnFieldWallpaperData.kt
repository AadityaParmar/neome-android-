...
import com.neome.api.meta.base.dto.DefnFieldWallpaper
...
@Serializable
sealed interface DefnFieldWallpaperSeal : DefnFieldWallpaper


@Serializable
data class DefnFieldWallpaperData(
...
) : DefnCompSeal, DefnFieldWallpaper
