...
import com.neome.api.meta.base.dto.DefnFieldSetOfRole
...
@Serializable
sealed interface DefnFieldSetOfRoleSeal : DefnFieldSetOfRole


@Serializable
data class DefnFieldSetOfRoleData(
    ...
    override val defaultRoleIdSet: Array<@Serializable(with = MetaIdRoleSer::class) Types.MetaIdRole>? = null,
...
) : DefnCompSeal, DefnFieldSetOfRole
