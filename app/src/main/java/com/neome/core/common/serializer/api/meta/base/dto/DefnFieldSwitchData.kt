...
@Serializable
sealed interface DefnFieldSwitchSeal : DefnFieldSwitch


@Serializable
data class DefnFieldSwitchData(
    ...
    override val checkboxLabelVar: DefnDtoTextData? = null,
    ...
    override val defaultVar: Boolean? = null,
    override val labelPlacement: EnumDefnPlacement? = null,
    override val labelPlacementVar: EnumDefnPlacement? = null,
    override val position: EnumDefnPlacement? = null,
    override val positionVar: EnumDefnPlacement? = null,
