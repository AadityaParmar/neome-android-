...
import com.neome.core.common.serializer.api.meta.base.dto.DefnVisibilityActionData
...
data class DefnVisibilityActionMapData(
    ...
    override val map: Map<@Serializable(with = MetaIdVisibilityActionSer::class) Types.MetaIdVisibilityAction, DefnVisibilityActionData>
