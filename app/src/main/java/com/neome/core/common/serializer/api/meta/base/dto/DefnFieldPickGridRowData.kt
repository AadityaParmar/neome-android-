...
import com.neome.core.common.serializer.api.meta.base.dto.DefnStudioDtoConditionData
...
@Serializable
sealed interface DefnFieldPickGridRowSeal : DefnFieldPickGridRow


@Serializable
data class DefnFieldPickGridRowData(
    ...
    override val filterConditionVar: DefnStudioDtoConditionData? = null,
    @Serializable(with = MetaIdFieldSer::class) override val gridDisplayFieldId: Types.MetaIdField,
...
) : DefnCompSeal, DefnFieldPickGridRow
