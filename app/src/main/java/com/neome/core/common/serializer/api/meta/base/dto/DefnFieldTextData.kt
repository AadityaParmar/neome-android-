...
import com.neome.core.common.serializer.api.meta.base.dto.DefnDtoTextValidationPatternData
...
@Serializable
sealed interface DefnFieldTextSeal : DefnFieldText


@Serializable
data class DefnFieldTextData(
    ...
    override val validationPattern: DefnDtoTextValidationPatternData? = null
) : DefnCompSeal, DefnFieldText
