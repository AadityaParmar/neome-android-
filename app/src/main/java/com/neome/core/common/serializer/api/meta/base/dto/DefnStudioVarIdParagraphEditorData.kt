...
import com.neome.api.meta.base.dto.DefnStudioVarIdParagraphEditor
...
@Serializable
sealed interface DefnStudioVarIdParagraphEditorSeal : DefnStudioVarIdParagraphEditor


@Serializable
data class DefnStudioVarIdParagraphEditorData(
    ...
    @Serializable(with = MetaIdFormSer::class) override val argBinderFormId: Types.MetaIdForm,
...
) : DefnCompSeal, DefnStudioVarIdParagraphEditor
