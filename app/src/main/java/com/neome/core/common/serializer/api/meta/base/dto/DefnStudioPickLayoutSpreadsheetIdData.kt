...
data class DefnStudioPickLayoutSpreadsheetIdData(
    ...
    override val excludeLayoutSpreadsheetIdSet: List<@Serializable(with = MetaIdLayoutGridSer::class) Types.MetaIdLayoutGrid>? = null,
    override val filterLayoutKindSet: List<EnumDefnLayoutGridKind>? = null,
