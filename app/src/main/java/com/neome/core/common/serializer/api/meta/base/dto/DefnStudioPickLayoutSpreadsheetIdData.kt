...
import com.neome.api.meta.base.dto.DefnStudioPickLayoutSpreadsheetId
...
@Serializable
sealed interface DefnStudioPickLayoutSpreadsheetIdSeal : DefnStudioPickLayoutSpreadsheetId


@Serializable
data class DefnStudioPickLayoutSpreadsheetIdData(
    ...
    override val excludeLayoutSpreadsheetIdSet: Array<@Serializable(with = MetaIdLayoutGridSer::class) Types.MetaIdLayoutGrid>? = null,
    override val filterLayoutKindSet: Array<EnumDefnLayoutGridKind>? = null,
    override val showAlias: Boolean? = null,
    @Serializable(with = MetaIdSpreadsheetSer::class) override val spreadsheetId: Types.MetaIdSpreadsheet
) : DefnCompSeal, DefnStudioPickLayoutSpreadsheetId
