...
import com.neome.api.meta.base.dto.StudioFieldLogDecimal
...
@Serializable
data class StudioFieldLogDecimalData(
    ...
    @Serializable(with = MetaIdVarSer::class) override val numberOfDigitsAfterPeriodVarId: Types.MetaIdVar? = null,
    override val logReadRoleSet: Array<@Serializable(with = MetaIdRoleSer::class) Types.MetaIdRole>? = null
) : StudioFieldLogDecimal
