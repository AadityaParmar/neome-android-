...
import com.neome.api.meta.base.dto.DefnFieldRefContact
...
@Serializable
sealed interface DefnFieldRefContactSeal : DefnFieldRefContact


@Serializable
data class DefnFieldRefContactData(
    ...
    override val editableContactFieldSet: Array<EnumContactCopyField>? = null
) : DefnCompSeal, DefnFieldRefContact
