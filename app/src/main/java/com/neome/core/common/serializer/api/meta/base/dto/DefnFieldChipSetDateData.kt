...
import com.neome.api.meta.base.dto.DefnFieldChipSetDate
...
@Serializable
sealed interface DefnFieldChipSetDateSeal : DefnFieldChipSetDate


@Serializable
data class DefnFieldChipSetDateData(
    ...
    override val defaultVar: Array<String>? = null,
...
) : DefnCompSeal, DefnFieldChipSetDate
