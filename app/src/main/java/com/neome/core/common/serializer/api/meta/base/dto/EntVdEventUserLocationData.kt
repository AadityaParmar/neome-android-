...
import com.neome.api.meta.base.dto.EntVdEventUserLocation
...
@Serializable
data class EntVdEventUserLocationData(
    ...
    override val locationCapture: StudioDtoLocationCaptureData? = null
) : EntVdEventUserLocation
