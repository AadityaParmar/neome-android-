...
import com.neome.core.common.serializer.sysId.AnyEmailIdSer
...
@Serializable
sealed interface DefnFieldEmailSeal : DefnFieldEmail


@Serializable
data class DefnFieldEmailData(
    ...
    @Serializable(with = AnyEmailIdSer::class) override val defaultValue: AnyEmailId? = null,
    @Serializable(with = AnyEmailIdSer::class) override val defaultVar: AnyEmailId? = null,
    override val invalidDomainSetVar: Array<String>? = null,
    override val validDomainSetVar: Array<String>? = null
) : DefnCompSeal, DefnFieldEmail
