...
import com.neome.api.meta.base.dto.EntVdBranchSwitchForm
...
import com.neome.core.common.serializer.api.meta.base.dto.EntVdFormMapData
...
@Serializable
data class EntVdBranchSwitchFormData(
    ...
    override val formMap: EntVdFormMapData? = null
) : EntVdBranchSwitchForm
