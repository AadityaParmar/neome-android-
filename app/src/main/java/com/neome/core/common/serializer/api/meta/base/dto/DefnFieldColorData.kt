...
import com.neome.api.meta.base.dto.DefnFieldColor
...
@Serializable
sealed interface DefnFieldColorSeal : DefnFieldColor


@Serializable
data class DefnFieldColorData(
