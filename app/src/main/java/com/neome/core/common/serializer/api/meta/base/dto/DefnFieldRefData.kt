...
data class DefnFieldRefData(
    ...
    override val layoutSpreadsheet: DefnLayoutGrid? = null,
    @Serializable(with = MetaIdFieldSer::class) override val lookupFieldId: Types.MetaIdField? = null,
    override val mobileLayoutSpreadsheet: DefnLayoutGrid? = null,
    override val mobileOverlayLayoutSpreadsheet: DefnDtoLayoutOverlaySpreadsheet? = null,
    override val overlayLayoutSpreadsheet: DefnDtoLayoutOverlaySpreadsheet? = null,
