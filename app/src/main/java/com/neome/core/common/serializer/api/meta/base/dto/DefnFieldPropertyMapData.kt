...
import com.neome.api.meta.base.dto.DefnFieldPropertyMap
...
@Serializable
sealed interface DefnFieldPropertyMapSeal : DefnFieldPropertyMap


@Serializable
data class DefnFieldPropertyMapData(
    ...
    override val defaultVar: Map<String, String>? = null
) : DefnCompSeal, DefnFieldPropertyMap
