...
import com.neome.api.meta.base.dto.DefnFieldIdentifier
...
@Serializable
sealed interface DefnFieldIdentifierSeal : DefnFieldIdentifier


@Serializable
data class DefnFieldIdentifierData(
    ...
    override val setOnSend: Boolean? = null,
    override val textPatternVar: DefnDtoTextData? = null
) : DefnCompSeal, DefnFieldIdentifier
