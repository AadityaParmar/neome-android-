...
data class DefnStudioPickPluginCompIdData(
    ...
    override val excludeCompositeIdSet: List<@Serializable(with = MetaIdCompositeSer::class) Types.MetaIdComposite>? = null,
    override val filterCompTypeSet: List<EnumDefnCompType>? = null,
