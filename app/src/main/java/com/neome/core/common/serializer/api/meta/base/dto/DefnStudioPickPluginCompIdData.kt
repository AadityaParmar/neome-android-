...
import com.neome.api.meta.base.dto.DefnStudioPickPluginCompId
...
@Serializable
sealed interface DefnStudioPickPluginCompIdSeal : DefnStudioPickPluginCompId


@Serializable
data class DefnStudioPickPluginCompIdData(
    ...
    override val excludeCompositeIdSet: Array<@Serializable(with = MetaIdCompositeSer::class) Types.MetaIdComposite>? = null,
    override val filterCompTypeSet: Array<EnumDefnCompType>? = null,
...
) : DefnCompSeal, DefnStudioPickPluginCompId
