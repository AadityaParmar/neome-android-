...
data class StudioEntPluginData(
    ...
    override val pluginApiIdKeys: Array<@Serializable(with = PluginApiIdSer::class) Types.PluginApiId>,
    override val pluginApiIdMap: Map<@Serializable(with = PluginApiIdSer::class) Types.PluginApiId, StudioEntPluginApi>,
    ...
    override val pluginFormKeys: Array<@Serializable(with = MetaIdFormSer::class) Types.MetaIdForm>,
    override val pluginFormMap: Map<@Serializable(with = MetaIdFormSer::class) Types.MetaIdForm, DefnForm>,
    @Serializable(with = PluginIdSer::class) override val pluginId: Types.PluginId,
    override val pluginName: String,
    override val pluginResourceMap: StudioEntPluginResourceMap? = null,
    override val pluginVarKeys: Array<@Serializable(with = MetaIdVarSer::class) Types.MetaIdVar>,
    override val pluginVarMap: Map<@Serializable(with = MetaIdVarSer::class) Types.MetaIdVar, StudioVar>,
