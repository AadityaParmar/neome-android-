...
@Serializable
sealed interface DtoMessagePayloadOptionalTextSeal : DtoMessagePayloadOptionalText


@Serializable
data class DtoMessagePayloadOptionalTextData(
...
) : DtoMessagePayloadSeal, DtoMessagePayloadOptionalText
