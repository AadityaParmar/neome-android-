...
data class StudioCompositeMapData(
    override val keys: List<@Serializable(with = MetaIdCompositeSer::class) Types.MetaIdComposite>,
    override val map: Map<@Serializable(with = MetaIdCompositeSer::class) Types.MetaIdComposite, StudioCompositeData>
) : StudioCompositeMap
