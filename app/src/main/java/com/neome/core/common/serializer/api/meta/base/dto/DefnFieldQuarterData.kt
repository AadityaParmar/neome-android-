...
import com.neome.api.meta.base.dto.DefnFieldQuarter
...
@Serializable
sealed interface DefnFieldQuarterSeal : DefnFieldQuarter


@Serializable
data class DefnFieldQuarterData(
    ...
    override val defaultValue: EnumDefnQuarter? = null,
    override val defaultVar: EnumDefnQuarter? = null
) : DefnCompSeal, DefnFieldQuarter
