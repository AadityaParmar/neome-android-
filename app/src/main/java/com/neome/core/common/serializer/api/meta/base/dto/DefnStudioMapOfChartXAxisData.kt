...
import com.neome.core.common.serializer.api.meta.base.dto.DefnDtoChartXAxisData
...
data class DefnStudioMapOfChartXAxisData(
    ...
    override val map: Map<@Serializable(with = MetaIdChartXAxisSer::class) Types.MetaIdChartXAxis, DefnDtoChartXAxisData>
