...
import com.neome.api.meta.base.dto.StudioEntAutomationStepSendMessageToUsers
...
@Serializable
data class StudioEntAutomationStepSendMessageToUsersData(
    ...
    @Serializable(with = MetaIdPipelineParamSer::class) override val targetUserDataSourcePipelineVarId: Types.MetaIdPipelineParam? = null
) : StudioEntAutomationStepSendMessageToUsers
