...
import com.neome.api.meta.base.dto.DefnStudioPickLayoutGridId
...
@Serializable
sealed interface DefnStudioPickLayoutGridIdSeal : DefnStudioPickLayoutGridId


@Serializable
data class DefnStudioPickLayoutGridIdData(
    ...
    override val excludeLayoutGridIdSet: Array<@Serializable(with = MetaIdLayoutGridSer::class) Types.MetaIdLayoutGrid>,
...
) : DefnCompSeal, DefnStudioPickLayoutGridId
