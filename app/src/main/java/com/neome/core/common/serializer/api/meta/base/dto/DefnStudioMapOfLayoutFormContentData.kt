...
import com.neome.api.meta.base.dto.DefnStudioMapOfLayoutFormContent
...
@Serializable
sealed interface DefnStudioMapOfLayoutFormContentSeal : DefnStudioMapOfLayoutFormContent


@Serializable
data class DefnStudioMapOfLayoutFormContentData(
    ...
    @Serializable(with = MetaIdLayoutFormSer::class) override val defaultId: Types.MetaIdLayoutForm? = null,
    @Serializable(with = MetaIdFormSer::class) override val formId: Types.MetaIdForm
) : DefnCompSeal, DefnStudioMapOfLayoutFormContent
