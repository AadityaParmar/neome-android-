...
import com.neome.api.meta.base.dto.EntVdExpertResume
...
@Serializable
data class EntVdExpertResumeData(
    ...
    override val option: StudioBuildArgBinder? = null,
    override val pauseKey: StudioValueText? = null
) : EntVdExpertResume
