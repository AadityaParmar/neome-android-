...
@Serializable
sealed interface DefnFieldSymbolSeal : DefnFieldSymbol


@Serializable
data class DefnFieldSymbolData(
    ...
    @Serializable(with = SymbolSer::class) override val defaultValue: Symbol? = null,
    @Serializable(with = SymbolSer::class) override val defaultVar: Symbol? = null
) : DefnCompSeal, DefnFieldSymbol
