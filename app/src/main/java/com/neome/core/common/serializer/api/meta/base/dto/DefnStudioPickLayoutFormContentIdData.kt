...
import com.neome.api.meta.base.dto.DefnStudioPickLayoutFormContentId
...
@Serializable
sealed interface DefnStudioPickLayoutFormContentIdSeal : DefnStudioPickLayoutFormContentId


@Serializable
data class DefnStudioPickLayoutFormContentIdData(
    ...
    override val excludeLayoutFormContentIdSet: Array<@Serializable(with = MetaIdLayoutFormSer::class) Types.MetaIdLayoutForm>? = null,
    override val filterKindSet: Array<EnumDefnFormLayoutType>? = null,
    @Serializable(with = MetaIdFormSer::class) override val formId: Types.MetaIdForm
) : DefnCompSeal, DefnStudioPickLayoutFormContentId
