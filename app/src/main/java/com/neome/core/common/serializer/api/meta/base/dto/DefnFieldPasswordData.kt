...
@Serializable
sealed interface DefnFieldPasswordSeal : DefnFieldPassword


@Serializable
data class DefnFieldPasswordData(
    ...
    override val defaultVar: DefnDtoTextData? = null,
    ...
    override val requireLowerCaseChar: Boolean? = null,
    override val requireNumericChar: Boolean? = null,
    override val requireSpecialChar: Boolean? = null,
    override val requireUpperCaseChar: Boolean? = null,
    override val securePassword: Boolean? = null
) : DefnCompSeal, DefnFieldPassword
