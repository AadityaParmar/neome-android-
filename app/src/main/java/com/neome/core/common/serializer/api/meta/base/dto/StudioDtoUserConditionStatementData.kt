...
data class StudioDtoUserConditionStatementData(
    override val derivedRoleIdSet: List<@Serializable(with = MetaIdRoleSer::class) Types.MetaIdRole>? = null,
    ...
    override val userContextSet: List<EnumDefnUserContext>? = null
