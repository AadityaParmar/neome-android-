...
import com.neome.api.meta.base.dto.EntVdExecuteSchedulerRemove
...
@Serializable
data class EntVdExecuteSchedulerRemoveData(
    ...
    override val forSchedulerIdField: StudioDtoArgValueParameterData? = null
) : EntVdExecuteSchedulerRemove
