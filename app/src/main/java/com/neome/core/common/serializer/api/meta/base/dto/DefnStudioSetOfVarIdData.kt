...
import com.neome.api.meta.base.dto.DefnStudioSetOfVarId
...
@Serializable
sealed interface DefnStudioSetOfVarIdSeal : DefnStudioSetOfVarId


@Serializable
data class DefnStudioSetOfVarIdData(
    ...
    override val varKindSet: Array<EnumStudioVarKind>? = null
) : DefnCompSeal, DefnStudioSetOfVarId
