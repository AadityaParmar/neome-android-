...
import com.neome.api.meta.base.dto.StudioEntAutomationStepRemoveUser
...
@Serializable
data class StudioEntAutomationStepRemoveUserData(
    ...
    @Serializable(with = MetaIdFieldSer::class) override val removeUserFieldId: Types.MetaIdField? = null
) : StudioEntAutomationStepRemoveUser
