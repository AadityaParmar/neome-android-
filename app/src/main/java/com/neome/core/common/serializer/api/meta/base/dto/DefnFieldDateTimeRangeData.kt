...
import com.neome.api.meta.base.dto.DefnFieldDateTimeRange
...
@Serializable
sealed interface DefnFieldDateTimeRangeSeal : DefnFieldDateTimeRange


@Serializable
data class DefnFieldDateTimeRangeData(
    ...
    override val defaultValue: DefnBuildDateTime? = null,
    override val defaultVar: DefnBuildDateTime? = null,
    override val displayDateFormat: String? = null,
    override val max: DefnBuildDateTime? = null,
    @Serializable(with = MetaIdFieldSer::class) override val maxFieldId: Types.MetaIdField? = null,
    override val maxVar: DefnBuildDateTime? = null,
    override val min: DefnBuildDateTime? = null,
    @Serializable(with = MetaIdFieldSer::class) override val minFieldId: Types.MetaIdField? = null,
    override val minVar: DefnBuildDateTime? = null,
    @Serializable(with = TimeZoneKeySer::class) override val timeZone: Types.TimeZoneKey? = null,
    override val allowSingleDate: Boolean? = null,
    override val fromDefault: DefnBuildDateTime? = null,
    @Serializable(with = MetaIdFieldSer::class) override val fromDefaultFieldId: Types.MetaIdField? = null,
    override val fromDefaultVar: DefnBuildDateTime? = null,
    override val toDefault: DefnBuildDateTime? = null,
    @Serializable(with = MetaIdFieldSer::class) override val toDefaultFieldId: Types.MetaIdField? = null,
    override val toDefaultVar: DefnBuildDateTime? = null
) : DefnCompSeal, DefnFieldDateTimeRange
