...
import com.neome.api.meta.base.dto.DefnFieldRating
...
@Serializable
sealed interface DefnFieldRatingSeal : DefnFieldRating


@Serializable
data class DefnFieldRatingData(
    ...
    override val ratingKind: EnumDefnKindRating? = null,
    override val ratingKindVar: EnumDefnKindRating? = null
) : DefnCompSeal, DefnFieldRating
