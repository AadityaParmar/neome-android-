...
import com.neome.core.common.serializer.api.ent.base.dto.DtoEntGroupData
...
data class DtoEntGroupMapData(
    override val entGroupMap: Map<@Serializable(with = GroupIdSer::class) Types.GroupId, DtoEntGroupData>
) : DtoEntGroupMap
