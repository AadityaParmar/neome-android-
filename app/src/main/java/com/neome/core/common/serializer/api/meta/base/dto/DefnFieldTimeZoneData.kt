...
import com.neome.api.meta.base.dto.DefnFieldTimeZone
...
@Serializable
sealed interface DefnFieldTimeZoneSeal : DefnFieldTimeZone


@Serializable
data class DefnFieldTimeZoneData(
    ...
    @Serializable(with = TimeZoneKeySer::class) override val defaultValue: Types.TimeZoneKey? = null,
    @Serializable(with = TimeZoneKeySer::class) override val defaultVar: Types.TimeZoneKey? = null
) : DefnCompSeal, DefnFieldTimeZone
