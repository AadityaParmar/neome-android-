...
import com.neome.api.meta.base.dto.DefnFieldLineStroke
...
@Serializable
sealed interface DefnFieldLineStrokeSeal : DefnFieldLineStroke


@Serializable
data class DefnFieldLineStrokeData(
    ...
    override val defaultVar: EnumDefnThemeStroke? = null
) : DefnCompSeal, DefnFieldLineStroke
