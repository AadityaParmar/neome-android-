...
@Serializable
sealed interface DefnFieldSetOfDocumentSeal : DefnFieldSetOfDocument


@Serializable
data class DefnFieldSetOfDocumentData(
    ...
    override val fileTypeSet: Array<EnumDefnDocFileExt>? = null,
...
) : DefnCompSeal, DefnFieldSetOfDocument
