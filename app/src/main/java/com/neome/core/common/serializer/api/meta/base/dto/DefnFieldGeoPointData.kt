...
import com.neome.api.meta.base.dto.DefnFieldGeoPoint
...
@Serializable
sealed interface DefnFieldGeoPointSeal : DefnFieldGeoPoint


@Serializable
data class DefnFieldGeoPointData(
    ...
    @Serializable(with = GeoPointSer::class) override val defaultValue: Types.GeoPoint? = null
) : DefnCompSeal, DefnFieldGeoPoint
