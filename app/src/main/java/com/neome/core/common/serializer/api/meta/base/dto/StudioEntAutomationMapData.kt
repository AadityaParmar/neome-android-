...
data class StudioEntAutomationMapData(
    override val keys: Array<@Serializable(with = MetaIdAutomationSer::class) Types.MetaIdAutomation>,
    override val map: Map<@Serializable(with = MetaIdAutomationSer::class) Types.MetaIdAutomation, StudioEntAutomation>
