...
import com.neome.api.meta.base.dto.StudioEntAutomationStepRemoveField
...
@Serializable
data class StudioEntAutomationStepRemoveFieldData(
    ...
    @Serializable(with = MetaIdPipelineParamSer::class) override val formPipelineVarId: Types.MetaIdPipelineParam? = null,
    @Serializable(with = MetaIdFieldSer::class) override val removeFieldId: Types.MetaIdField? = null
) : StudioEntAutomationStepRemoveField
