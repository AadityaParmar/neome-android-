...
import com.neome.api.meta.base.dto.DefnStudioMapOfMapping
...
@Serializable
sealed interface DefnStudioMapOfMappingSeal : DefnStudioMapOfMapping


@Serializable
data class DefnStudioMapOfMappingData(
    ...
    @Serializable(with = MetaIdFormSer::class) override val toFormId: Types.MetaIdForm,
...
) : DefnCompSeal, DefnStudioMapOfMapping
