...
import com.neome.api.meta.base.dto.StudioFieldPickReportRow
...
@Serializable
data class StudioFieldPickReportRowData(
    ...
    @Serializable(with = MetaIdLayoutGridSer::class) override val reportOutputFormGridLayoutId: Types.MetaIdLayoutGrid? = null,
