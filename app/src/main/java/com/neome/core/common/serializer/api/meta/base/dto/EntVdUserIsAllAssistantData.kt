...
import com.neome.api.meta.base.dto.EntVdUserIsAllAssistant
...
@Serializable
data class EntVdUserIsAllAssistantData(
    ...
    override val assistantField: StudioDtoArgValueParameterData? = null,
    override val user: StudioBuildArgBinderData? = null
) : EntVdUserIsAllAssistant
