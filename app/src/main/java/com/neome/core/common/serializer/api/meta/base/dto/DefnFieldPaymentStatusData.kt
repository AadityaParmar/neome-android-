...
import com.neome.api.meta.base.dto.DefnFieldPaymentStatus
...
@Serializable
sealed interface DefnFieldPaymentStatusSeal : DefnFieldPaymentStatus


@Serializable
data class DefnFieldPaymentStatusData(
    ...
    override val defaultValue: EnumDefnPaymentStatus? = null
) : DefnCompSeal, DefnFieldPaymentStatus
