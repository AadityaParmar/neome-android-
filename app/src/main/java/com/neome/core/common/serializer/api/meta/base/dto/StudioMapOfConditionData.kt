...
data class StudioMapOfConditionData(
    ...
    override val map: Map<@Serializable(with = MetaIdConditionSer::class) Types.MetaIdCondition, StudioMapOfCondition>? = null,
    @Serializable(with = MetaIdConditionSer::class) override val metaId: Types.MetaIdCondition,
    override val statement: StudioDtoConditionStatement? = null
