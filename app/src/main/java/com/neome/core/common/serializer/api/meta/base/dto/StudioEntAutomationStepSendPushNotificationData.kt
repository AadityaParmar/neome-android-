...
import com.neome.api.meta.base.dto.StudioEntAutomationStepSendPushNotification
...
@Serializable
data class StudioEntAutomationStepSendPushNotificationData(
    ...
    override val sendCustomMessage: Boolean? = null,
    override val titleVarId: StudioValueVarIdTextData? = null
) : StudioEntAutomationStepSendPushNotification
