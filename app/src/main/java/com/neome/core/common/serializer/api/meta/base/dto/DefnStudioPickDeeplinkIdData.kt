...
import com.neome.api.meta.base.dto.DefnStudioPickDeeplinkId
...
@Serializable
sealed interface DefnStudioPickDeeplinkIdSeal : DefnStudioPickDeeplinkId


@Serializable
data class DefnStudioPickDeeplinkIdData(
    ...
    override val includeDeeplinkIdSet: Array<@Serializable(with = MetaIdDeeplinkSer::class) Types.MetaIdDeeplink>? = null
) : DefnCompSeal, DefnStudioPickDeeplinkId
