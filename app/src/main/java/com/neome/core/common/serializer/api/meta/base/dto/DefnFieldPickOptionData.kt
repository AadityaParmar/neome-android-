...
import com.neome.api.meta.base.dto.DefnFieldPickOption
...
@Serializable
sealed interface DefnFieldPickOptionSeal : DefnFieldPickOption


@Serializable
data class DefnFieldPickOptionData(
    ...
    override val optionSet: Array<String>
) : DefnCompSeal, DefnFieldPickOption
