...
data class StudioPluginApiMapData(
    override val keys: Array<@Serializable(with = PluginApiIdSer::class) Types.PluginApiId>,
    override val map: Map<@Serializable(with = PluginApiIdSer::class) Types.PluginApiId, StudioPluginApi>,
