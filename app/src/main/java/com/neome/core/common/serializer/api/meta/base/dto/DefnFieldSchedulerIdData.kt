...
import com.neome.api.meta.base.dto.DefnFieldSchedulerId
...
@Serializable
sealed interface DefnFieldSchedulerIdSeal : DefnFieldSchedulerId


@Serializable
data class DefnFieldSchedulerIdData(
...
) : DefnCompSeal, DefnFieldSchedulerId
