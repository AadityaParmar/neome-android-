...
data class EntVdSsSearchData(
    ...
    override val searchSpreadsheetIdSet: Array<@Serializable(with = MetaIdSpreadsheetSer::class) Types.MetaIdSpreadsheet>? = null,
    override val searchText: StudioBuildArgBinder? = null
) : EntVdSsSearch
