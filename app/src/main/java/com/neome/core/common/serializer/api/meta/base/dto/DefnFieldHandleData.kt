...
@Serializable
sealed interface DefnFieldHandleSeal : DefnFieldHandle


@Serializable
data class DefnFieldHandleData(
    ...
    override val defaultVar: String? = null,
    override val invalidDomainSetVar: Array<String>? = null,
    override val invalidMobileCountryCodeSetVar: Array<String>? = null,
    override val validDomainSetVar: Array<String>? = null,
    override val validMobileCountryCodeSetVar: Array<String>? = null
) : DefnCompSeal, DefnFieldHandle
