...
import com.neome.api.meta.base.dto.DefnFieldCarousel
...
@Serializable
sealed interface DefnFieldCarouselSeal : DefnFieldCarousel


@Serializable
data class DefnFieldCarouselData(
    ...
    override val borderRadius: Array<Long>? = null,
    ...
    override val showAsCard: Boolean? = null,
    override val showMediaPlaceholder: Boolean? = null,
    override val width: Long? = null
) : DefnCompSeal, DefnFieldCarousel
