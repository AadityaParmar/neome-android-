...
data class EntVdApplyTransformsData(
    ...
    override val keys: Array<@Serializable(with = MetaIdVdAutoFuncSer::class) Types.MetaIdVdAutoFunc>,
    override val map: Map<@Serializable(with = MetaIdVdAutoFuncSer::class) Types.MetaIdVdAutoFunc, AutoXform>
