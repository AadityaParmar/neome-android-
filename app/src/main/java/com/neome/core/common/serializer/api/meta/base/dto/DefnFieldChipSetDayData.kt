...
import com.neome.api.meta.base.dto.DefnFieldChipSetDay
...
@Serializable
sealed interface DefnFieldChipSetDaySeal : DefnFieldChipSetDay


@Serializable
data class DefnFieldChipSetDayData(
    ...
    override val defaultValue: Array<EnumDefnDay>? = null,
    override val defaultVar: Array<EnumDefnDay>? = null
) : DefnCompSeal, DefnFieldChipSetDay
