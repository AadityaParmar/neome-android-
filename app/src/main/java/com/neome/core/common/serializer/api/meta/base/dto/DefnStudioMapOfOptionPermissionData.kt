...
import com.neome.core.common.serializer.api.meta.base.dto.DefnStudioDtoOptionPermissionData
...
data class DefnStudioMapOfOptionPermissionData(
    ...
    override val map: Map<@Serializable(with = MetaIdRoleSer::class) Types.MetaIdRole, DefnStudioDtoOptionPermissionData>
