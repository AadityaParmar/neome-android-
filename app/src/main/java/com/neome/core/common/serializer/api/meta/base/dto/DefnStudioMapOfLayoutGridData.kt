...
import com.neome.api.meta.base.dto.DefnStudioMapOfLayoutGrid
...
@Serializable
sealed interface DefnStudioMapOfLayoutGridSeal : DefnStudioMapOfLayoutGrid


@Serializable
data class DefnStudioMapOfLayoutGridData(
    ...
    override val isPluginForm: Boolean? = null
) : DefnCompSeal, DefnStudioMapOfLayoutGrid
