...
import com.neome.api.meta.base.dto.StudioEntAutomationStepValidation
...
@Serializable
data class StudioEntAutomationStepValidationData(
    ...
    override val validationConditionVarId: StudioValueVarIdConditionData? = null
) : StudioEntAutomationStepValidation
