...
import com.neome.api.meta.base.dto.EntVdUserIsAllManager
...
@Serializable
data class EntVdUserIsAllManagerData(
    ...
    override val managerField: StudioDtoArgValueParameterData? = null,
    override val user: StudioBuildArgBinderData? = null
) : EntVdUserIsAllManager
