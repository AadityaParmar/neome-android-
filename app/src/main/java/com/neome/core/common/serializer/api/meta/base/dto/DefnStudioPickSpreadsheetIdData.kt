...
import com.neome.api.meta.base.dto.DefnStudioPickSpreadsheetId
...
@Serializable
sealed interface DefnStudioPickSpreadsheetIdSeal : DefnStudioPickSpreadsheetId


@Serializable
data class DefnStudioPickSpreadsheetIdData(
    ...
    override val excludeSpreadsheetIdSet: Array<@Serializable(with = MetaIdSpreadsheetSer::class) Types.MetaIdSpreadsheet>? = null,
    override val showAlias: Boolean? = null
) : DefnCompSeal, DefnStudioPickSpreadsheetId
