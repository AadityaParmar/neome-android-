...
import com.neome.api.meta.base.dto.DefnFieldLogCounter
...
@Serializable
sealed interface DefnFieldLogCounterSeal : DefnFieldLogCounter


@Serializable
data class DefnFieldLogCounterData(
    ...
    override val defaultVar: Long? = null,
    ...
    override val minVar: Long? = null,
    override val step: Long? = null,
    @Serializable(with = MetaIdFieldSer::class) override val stepFieldId: Types.MetaIdField? = null,
    override val stepVar: Long? = null,
    override val hideInfo: Boolean? = null,
    override val logReadRoleSet: Array<@Serializable(with = MetaIdRoleSer::class) Types.MetaIdRole>? = null
) : DefnCompSeal, DefnFieldLogCounter
