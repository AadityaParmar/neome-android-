...
import com.neome.api.meta.base.dto.EntVdBotAddPromptToHistory
...
@Serializable
data class EntVdBotAddPromptToHistoryData(
    ...
    override val documentAttachment: StudioDtoArgValueParameterData? = null,
    override val imageAttachment: StudioDtoArgValueParameterData? = null,
    override val label: StudioBuildArgBinderData? = null,
    override val promptField: StudioDtoArgValueParameterData? = null
) : EntVdBotAddPromptToHistory
