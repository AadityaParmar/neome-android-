...
data class EntVdBotAddPromptToHistoryData(
    ...
    override val documentAttachment: StudioDtoArgValueParameter? = null,
    override val imageAttachment: StudioDtoArgValueParameter? = null,
    override val label: StudioBuildArgBinder? = null,
    override val promptField: StudioDtoArgValueParameter? = null
