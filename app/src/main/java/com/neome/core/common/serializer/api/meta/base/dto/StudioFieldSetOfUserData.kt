...
import com.neome.api.meta.base.dto.StudioFieldSetOfUser
...
@Serializable
data class StudioFieldSetOfUserData(
    ...
    @Serializable(with = MetaIdVarSer::class) override val showAsDropdownVarId: Types.MetaIdVar? = null
) : StudioFieldSetOfUser
