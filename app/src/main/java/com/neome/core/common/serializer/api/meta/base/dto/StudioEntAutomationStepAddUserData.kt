...
import com.neome.api.meta.base.dto.StudioEntAutomationStepAddUser
...
@Serializable
data class StudioEntAutomationStepAddUserData(
    ...
    @Serializable(with = MetaIdFieldSer::class) override val userHandleFieldId: Types.MetaIdField? = null,
    ...
    override val userRoleIdSet: Array<@Serializable(with = MetaIdRoleSer::class) Types.MetaIdRole>? = null
) : StudioEntAutomationStepAddUser
