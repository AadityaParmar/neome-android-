...
data class EntVdSendWhatsappTemplateData(
    ...
    override val buttonIdVarMap: StudioMapOfValueTextData? = null,
    override val carouselCardVarMap: StudioMapOfValueTextData? = null,
    override val templateGroupId: String? = null,
    override val templateMediaField: StudioDtoArgValueParameterData? = null,
    override val templateVarMap: StudioMapOfValueTextData? = null,
