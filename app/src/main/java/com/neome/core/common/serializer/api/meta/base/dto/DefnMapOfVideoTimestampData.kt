...
data class DefnMapOfVideoTimestampData(
    override val keys: Array<@Serializable(with = MetaIdVideoTimestampSer::class) Types.MetaIdVideoTimestamp>,
    override val map: Map<@Serializable(with = MetaIdVideoTimestampSer::class) Types.MetaIdVideoTimestamp, DefnDtoVideoTimestamp>
