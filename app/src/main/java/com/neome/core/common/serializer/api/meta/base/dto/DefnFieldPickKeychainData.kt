...
@Serializable
sealed interface DefnFieldPickKeychainSeal : DefnFieldPickKeychain


@Serializable
data class DefnFieldPickKeychainData(
    ...
    override val filterKind: EnumDefnKeychainType? = null
) : DefnCompSeal, DefnFieldPickKeychain
