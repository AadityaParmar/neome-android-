...
data class StudioEntReportMapData(
    override val keys: Array<@Serializable(with = MetaIdReportSer::class) Types.MetaIdReport>,
    override val map: Map<@Serializable(with = MetaIdReportSer::class) Types.MetaIdReport, StudioEntReport>
) : StudioEntReportMap
