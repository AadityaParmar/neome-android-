...
import com.neome.api.meta.base.dto.StudioEntAutomationStepGenerateImage
...
@Serializable
data class StudioEntAutomationStepGenerateImageData(
    ...
    override val fileNameVarId: StudioValueVarIdText? = null,
    ...
    @Serializable(with = MetaIdFieldSer::class) override val imageFieldId: Types.MetaIdField? = null,
    @Serializable(with = MetaIdFormSer::class) override val imageFormId: Types.MetaIdForm? = null,
    @Serializable(with = MetaIdVarSer::class) override val imageFormMappingVarId: Types.MetaIdVar? = null
) : StudioEntAutomationStepGenerateImage
