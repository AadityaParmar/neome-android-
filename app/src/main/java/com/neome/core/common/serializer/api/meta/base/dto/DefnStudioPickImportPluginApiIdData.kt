...
data class DefnStudioPickImportPluginApiIdData(
    ...
    override val excludePluginApiIdSet: List<@Serializable(with = PluginApiIdSer::class) Types.PluginApiId>? = null,
    override val filterApiMethodSet: List<EnumDefnPluginApiMethod>? = null,
