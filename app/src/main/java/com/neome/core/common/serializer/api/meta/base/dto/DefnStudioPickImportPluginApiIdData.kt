...
import com.neome.api.meta.base.dto.DefnStudioPickImportPluginApiId
...
@Serializable
sealed interface DefnStudioPickImportPluginApiIdSeal : DefnStudioPickImportPluginApiId


@Serializable
data class DefnStudioPickImportPluginApiIdData(
    ...
    override val excludePluginApiIdSet: Array<@Serializable(with = PluginApiIdSer::class) Types.PluginApiId>? = null,
    override val filterApiMethodSet: Array<EnumDefnPluginApiMethod>? = null,
    @Serializable(with = MetaIdPluginSer::class) override val metaIdPlugin: Types.MetaIdPlugin
) : DefnCompSeal, DefnStudioPickImportPluginApiId
