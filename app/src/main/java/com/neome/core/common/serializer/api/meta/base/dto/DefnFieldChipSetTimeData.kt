...
import com.neome.api.meta.base.dto.DefnFieldChipSetTime
...
@Serializable
sealed interface DefnFieldChipSetTimeSeal : DefnFieldChipSetTime


@Serializable
data class DefnFieldChipSetTimeData(
    ...
    override val defaultValue: Array<@Serializable(with = AnyTimeSer::class) Types.AnyTime>? = null,
    override val defaultVar: Array<@Serializable(with = AnyTimeSer::class) Types.AnyTime>? = null,
    override val displayDateFormat: String? = null
) : DefnCompSeal, DefnFieldChipSetTime
