...
data class DefnFieldChipSetTimeData(
    ...
    override val defaultValue: List<@Serializable(with = AnyTimeSer::class) Types.AnyTime>? = null,
    override val defaultVar: List<@Serializable(with = AnyTimeSer::class) Types.AnyTime>? = null,
