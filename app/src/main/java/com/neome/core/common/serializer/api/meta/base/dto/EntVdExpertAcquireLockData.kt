...
import com.neome.api.meta.base.dto.EntVdExpertAcquireLock
...
@Serializable
data class EntVdExpertAcquireLockData(
    ...
    override val duration: FieldDtoDurationData? = null,
    override val lockKey: StudioValueTextData? = null
) : EntVdExpertAcquireLock
