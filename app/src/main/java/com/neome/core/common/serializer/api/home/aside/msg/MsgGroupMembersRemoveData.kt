...
data class MsgGroupMembersRemoveData(
    ...
    override val removeAdminSet: Set<@Serializable(with = EntUserIdSer::class) Types.EntUserId>? = null,
    override val removeMemberSet: Set<@Serializable(with = EntUserIdSer::class) Types.EntUserId>? = null
