...
import com.neome.api.meta.base.dto.DefnFieldRowId
...
@Serializable
sealed interface DefnFieldRowIdSeal : DefnFieldRowId


@Serializable
data class DefnFieldRowIdData(
