...
data class StudioEntGroupMapData(
    override val keys: Array<@Serializable(with = MetaIdGroupSer::class) Types.MetaIdGroup>,
    override val map: Map<@Serializable(with = MetaIdGroupSer::class) Types.MetaIdGroup, StudioEntGroup>
) : StudioEntGroupMap
