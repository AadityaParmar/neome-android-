...
import com.neome.api.meta.base.dto.EntVdApplyFormula
...
@Serializable
data class EntVdApplyFormulaData(
    ...
    override val assignToField: StudioDtoArgValueParameterData? = null,
    override val javascriptFormula: StudioValueCodeJavascriptData? = null
) : EntVdApplyFormula
