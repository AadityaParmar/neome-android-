...
import com.neome.api.home.base.dto.DtoMessageReplyPayloadLocation
...
@Serializable
data class DtoMessageReplyPayloadLocationData(
    ...
    override val mapImageUrl: String
) : DtoMessageReplyPayloadLocation
