...
import com.neome.api.meta.base.dto.DefnFieldFormListItem
...
@Serializable
sealed interface DefnFieldFormListItemSeal : DefnFieldFormListItem


@Serializable
data class DefnFieldFormListItemData(
    ...
    override val opacityVar: Double? = null,
    ...
    override val isCard: Boolean? = null,
    override val layout: DefnDtoLayoutCardItemData? = null
) : DefnCompSeal, DefnFieldFormListItem
