...
data class StudioEntTranslationMapData(
    override val keys: Array<@Serializable(with = MetaIdTranslationSer::class) Types.MetaIdTranslation>,
    override val map: Map<@Serializable(with = MetaIdTranslationSer::class) Types.MetaIdTranslation, StudioEntTranslation>,
