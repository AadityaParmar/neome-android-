...
import com.neome.core.common.serializer.api.meta.base.dto.DefnVisibilityConditionData
...
data class DefnVisibilityConditionMapData(
    ...
    override val map: Map<@Serializable(with = MetaIdVisibilityConditionSer::class) Types.MetaIdVisibilityCondition, DefnVisibilityConditionMapData>? = null,
    @Serializable(with = MetaIdVisibilityConditionSer::class) override val metaId: Types.MetaIdVisibilityCondition,
    override val statement: DefnVisibilityConditionData? = null
