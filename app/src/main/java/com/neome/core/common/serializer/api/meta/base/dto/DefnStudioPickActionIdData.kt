...
data class DefnStudioPickActionIdData(
    ...
    override val excludeActionIdSet: List<@Serializable(with = MetaIdActionSer::class) Types.MetaIdAction>? = null,
    override val filterActionKindSet: List<EnumDefnKindAction>? = null,
