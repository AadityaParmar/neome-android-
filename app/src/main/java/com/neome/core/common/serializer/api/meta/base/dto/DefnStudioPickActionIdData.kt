...
import com.neome.api.meta.base.dto.DefnStudioPickActionId
...
@Serializable
sealed interface DefnStudioPickActionIdSeal : DefnStudioPickActionId


@Serializable
data class DefnStudioPickActionIdData(
    ...
    override val excludeActionIdSet: Array<@Serializable(with = MetaIdActionSer::class) Types.MetaIdAction>? = null,
    override val filterActionKindSet: Array<EnumDefnKindAction>? = null,
    override val includeActionIdSet: Array<@Serializable(with = MetaIdActionSer::class) Types.MetaIdAction>? = null
) : DefnCompSeal, DefnStudioPickActionId
