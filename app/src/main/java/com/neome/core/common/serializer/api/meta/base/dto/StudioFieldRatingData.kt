...
import com.neome.api.meta.base.dto.StudioFieldRating
...
@Serializable
data class StudioFieldRatingData(
    ...
    @Serializable(with = MetaIdVarSer::class) override val ratingKindVarId: Types.MetaIdVar? = null
) : StudioFieldRating
