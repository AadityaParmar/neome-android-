...
import com.neome.api.meta.base.dto.DefnStudioBuildPermissionMatrix
...
@Serializable
sealed interface DefnStudioBuildPermissionMatrixSeal : DefnStudioBuildPermissionMatrix


@Serializable
data class DefnStudioBuildPermissionMatrixData(
    ...
    override val filterOptionSet: Array<EnumDefnPermission>? = null
) : DefnCompSeal, DefnStudioBuildPermissionMatrix
