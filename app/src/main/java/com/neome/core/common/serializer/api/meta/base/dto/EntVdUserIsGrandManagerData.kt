...
import com.neome.api.meta.base.dto.EntVdUserIsGrandManager
...
@Serializable
data class EntVdUserIsGrandManagerData(
    ...
    override val grandManagerField: StudioDtoArgValueParameterData? = null,
    override val user: StudioBuildArgBinderData? = null
) : EntVdUserIsGrandManager
