...
import com.neome.api.meta.base.dto.StudioVarButtonVariant
...
@Serializable
data class StudioVarButtonVariantData(
    ...
    override val value: EnumDefnThemeButtonVariant? = null
) : StudioVarButtonVariant
