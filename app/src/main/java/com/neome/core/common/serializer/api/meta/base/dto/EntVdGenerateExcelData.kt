...
import com.neome.api.meta.base.dto.EntVdGenerateExcel
...
@Serializable
data class EntVdGenerateExcelData(
    ...
    override val fileName: StudioValueTextData? = null,
    @Serializable(with = MetaIdPipelineParamSer::class) override val formId: Types.MetaIdPipelineParam? = null,
    override val gridLayoutMap: Map<@Serializable(with = MetaIdGridSer::class) Types.MetaIdGrid, @Serializable(with = MetaIdLayoutGridSer::class) Types.MetaIdLayoutGrid>? = null,
    override val outputField: StudioDtoArgValueParameterData? = null,
    override val rowIdField: StudioDtoArgValueParameterData? = null,
