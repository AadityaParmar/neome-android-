...
import com.neome.api.meta.base.dto.StudioFieldRefTarget
...
import com.neome.core.common.serializer.api.meta.base.dto.StudioMapOfRefTargetData
...
@Serializable
data class StudioFieldRefTargetData(
    ...
    override val refTargetSpreadsheetMap: StudioMapOfRefTargetData? = null
) : StudioFieldRefTarget
