...
import com.neome.core.common.serializer.api.meta.base.dto.EntVdPipelineVarData
...
data class EntVdPipelineVarMapData(
    ...
    override val map: Map<@Serializable(with = MetaIdPipelineVarSer::class) Types.MetaIdPipelineVar, EntVdPipelineVarData>
) : EntVdPipelineVarMap
