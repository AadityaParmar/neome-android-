...
import com.neome.api.meta.base.dto.DefnStudioPickSpreadsheetRefLayoutId
...
@Serializable
sealed interface DefnStudioPickSpreadsheetRefLayoutIdSeal : DefnStudioPickSpreadsheetRefLayoutId


@Serializable
data class DefnStudioPickSpreadsheetRefLayoutIdData(
    ...
    @Serializable(with = MetaIdSpreadsheetRefSer::class) override val spreadsheetRefId: Types.MetaIdSpreadsheetRef? = null
) : DefnCompSeal, DefnStudioPickSpreadsheetRefLayoutId
