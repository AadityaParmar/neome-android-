...
import com.neome.api.meta.base.dto.DefnStudioBuildColor
...
@Serializable
sealed interface DefnStudioBuildColorSeal : DefnStudioBuildColor


@Serializable
data class DefnStudioBuildColorData(
    ...
    override val allowShades: Boolean? = null,
    override val direction: EnumDefnThemeDirection? = null
) : DefnCompSeal, DefnStudioBuildColor
