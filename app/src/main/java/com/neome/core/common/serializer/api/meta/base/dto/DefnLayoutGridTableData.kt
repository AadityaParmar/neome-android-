...
import com.neome.core.common.serializer.api.meta.base.dto.DefnMapOfTableStyleData
import com.neome.core.common.serializer.api.meta.base.dto.DefnStudioMapOfTableFooterData
import com.neome.core.common.serializer.api.meta.base.dto.DefnStudioMapOfTableHeaderData
...
data class DefnLayoutGridTableData(
    ...
    override val footer: DefnStudioMapOfTableFooterData? = null,
    override val freezeFieldIdSet: List<@Serializable(with = MetaIdFieldSer::class) Types.MetaIdField>? = null,
    override val header: DefnStudioMapOfTableHeaderData? = null,
    ...
    override val styleMap: DefnMapOfTableStyleData? = null,
