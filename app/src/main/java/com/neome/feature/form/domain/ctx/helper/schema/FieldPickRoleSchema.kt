...
import com.neome.core.common.serializer.api.meta.base.dto.FieldValueRoleData
...
class FieldPickRoleSchema(
    ...
    private fun buildValidation(properties: FieldProperties): Validation<FieldValueRoleData?> {
        return Validation {
            // Required check
