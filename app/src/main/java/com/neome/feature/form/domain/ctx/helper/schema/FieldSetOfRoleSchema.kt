...
class FieldSetOfRoleSchema(
    ...
    private fun buildValidation(properties: FieldProperties): Validation<FieldSetOfRoleData?> {
        return Validation {
