...
/**
 * CompSchema implementation for FieldSetOfUser.
 *
...
class FieldSetOfUserSchema(
    ...
    private val defnField = defnComp as? DefnFieldSetOfUser
    ...
    private fun buildValidation(properties: FieldProperties): Validation<FieldSetOfEntUserIdData?> {
        return Validation {
