...
- `com.neome.feature.form.domain.model.DefnFormUi` — UI-ready form definition (output of FilterForm preparation)
- `com.neome.feature.form.domain.model.TypeUiFormPermission`, `TypeUiFormPermissionMap`, `TypeUiFormParentMap`, `TypeUiPermissionRole`, `TypeUiManagerialRelationship` — Permission and relationship types
