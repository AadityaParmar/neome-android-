...
/**
 * CompSchema implementation for ChipSet fields.
 *
 * Covers: chipSet, chipSetDate, chipSetDateTime, chipSetDay, chipSetTime,
 * chipSetDeviceSize, chipSetDeviceType
 *
...
class FieldChipSetSchema(
    ...
    private fun buildValidation(properties: FieldProperties): Validation<FieldSetOfStringData?> {
        return Validation {
