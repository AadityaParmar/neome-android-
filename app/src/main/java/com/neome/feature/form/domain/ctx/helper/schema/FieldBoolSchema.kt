...
/**
 * CompSchema implementation for FieldBool (Switch).
 *
...
class FieldBoolSchema(
    ...
    private fun buildValidation(properties: FieldProperties): Validation<FieldValueSwitchData?> {
        return Validation {
            // Required check - value must be defined
