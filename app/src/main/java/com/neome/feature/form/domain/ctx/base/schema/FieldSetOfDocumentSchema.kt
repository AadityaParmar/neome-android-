...
import com.neome.api.meta.base.dto.DefnFieldSetOfDocument
import com.neome.core.common.serializer.api.meta.base.dto.DefnCompSeal
import com.neome.feature.form.domain.DefnFormUi
import com.neome.core.common.serializer.api.meta.base.dto.FieldSetOfDocumentData
...
class FieldSetOfDocumentSchema(
    ...
    override fun validate(fieldValue: JsonElement?, fieldState: FieldState?): String? {
        ...
        val typedValue = try {
            JsonParser.json.decodeFromJsonElement(
                FieldSetOfDocumentData.serializer(),
                fieldValue
            )
        } catch (e: Exception) {
            null
    ...
    private fun buildValidation(properties: FieldProperties): Validation<FieldSetOfDocumentData?> {
        return Validation {
            // Required check - mediaIdDocumentSet must not be empty
            if (properties.required) {
                constrain("Required") {
                    it != null && it.mediaIdDocumentSet.isNotEmpty()
                }
            }
        }
    }
