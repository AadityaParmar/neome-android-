  ...
  companion object
  {
    val SN: ServiceName = ServiceName.aside
      ...
      fun callerChatNotificationSettingPut(entId: EntId, msg: MsgCallerChatNotificationSettingPut, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, entId, SN, "callerChatNotificationSettingPut")
              .sendBearerToken()
              .put(msg, sigAcceptor)
          }
      ...
      fun groupCommonListGet(msg: MsgEntUserIdNoVersion, sigAcceptor: ISigAcceptor<SigGroupIdList>)
          {
            CallFactory.rpc.create(SigGroupIdList::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "groupCommonListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun groupInviteLinkGet(msg: MsgGroupInviteLink, sigAcceptor: ISigAcceptor<SigUrl>)
          {
            CallFactory.rpc.create(SigUrl::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "groupInviteLinkGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun groupMembersAdd(msg: MsgGroupMembersAdd, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "groupMembersAdd")
              .sendBearerToken()
              .put(msg, sigAcceptor)
          }
      ...
      fun groupMembersRemove(msg: MsgGroupMembersRemove, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "groupMembersRemove")
              .sendBearerToken()
              .put(msg, sigAcceptor)
          }
