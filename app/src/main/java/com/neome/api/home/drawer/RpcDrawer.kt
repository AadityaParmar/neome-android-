  ...
  companion object
  {
    val SN: ServiceName = ServiceName.drawer
      ...
      fun addressBookContactPatch(msg: MsgAddressBookContact, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "addressBookContactPatch")
              .sendBearerToken()
      ...
      fun addressBookContactPut(msg: MsgAddressBookContact, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "addressBookContactPut")
              .sendBearerToken()
              .put(msg, sigAcceptor)
          }
      ...
      fun addressBookContactRemove(msg: MsgHandle, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "addressBookContactRemove")
              .sendBearerToken()
      ...
      fun addressBookGet(msg: MsgVersion, sigAcceptor: ISigAcceptor<SigAddressBook>)
          {
            CallFactory.rpc.create(SigAddressBook::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "addressBookGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun addressBookInvite(msg: MsgHandle, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "addressBookInvite")
              .sendBearerToken()
      ...
      fun badgeMapGet(msg: MsgVersion, sigAcceptor: ISigAcceptor<SigBadgeMap>)
          {
            CallFactory.rpc.create(SigBadgeMap::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "badgeMapGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun callerAccountRemove(sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "callerAccountRemove")
              .sendRefreshToken()
      ...
      fun callerDeviceListGet(sigAcceptor: ISigAcceptor<SigCallerDeviceList>)
          {
            CallFactory.rpc.create(SigCallerDeviceList::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "callerDeviceListGet")
              .sendBearerToken()
      ...
      fun callerDeviceRemove(msg: MsgDeviceId, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "callerDeviceRemove")
              .sendRefreshToken()
              .delete(msg, sigAcceptor)
          }
      ...
      fun callerDeviceStatePut(msg: MsgCallerDeviceState, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "callerDeviceStatePut")
              .sendBearerToken()
              .put(msg, sigAcceptor)
          }

      fun callerHandleChange(msg: MsgCallerHandleChange, sigAcceptor: ISigAcceptor<SigVerifyKey>)
          {
            CallFactory.rpc.create(SigVerifyKey::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "callerHandleChange")
              .sendRefreshToken()
              .patch(msg, sigAcceptor)
          }
      ...
      fun callerPasswordReset(msg: MsgCallerPasswordReset, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "callerPasswordReset")
              .sendRefreshToken()
              .patch(msg, sigAcceptor)
          }
      ...
      fun callerProfilePatch(msg: MsgCallerProfilePatch, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "callerProfilePatch")
              .sendBearerToken()
              .patch(msg, sigAcceptor)
          }
      ...
      fun drawerSearch(msg: MsgDrawerSearch, sigAcceptor: ISigAcceptor<SigDrawerSearch>)
          {
            CallFactory.rpc.create(SigDrawerSearch::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "drawerSearch")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun groupCandidateListGet(msg: MsgGroupCandidateListGet, sigAcceptor: ISigAcceptor<SigGroupCandidateMap>)
          {
            CallFactory.rpc.create(SigGroupCandidateMap::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "groupCandidateListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun newChatCandidateListGet(msg: MsgEntFilterNoVersion, sigAcceptor: ISigAcceptor<SigChatCandidateMap>)
          {
            CallFactory.rpc.create(SigChatCandidateMap::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "newChatCandidateListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun recentListGet(msg: MsgEntFilter, sigAcceptor: ISigAcceptor<SigRecentList>)
          {
            CallFactory.rpc.create(SigRecentList::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "recentListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun starMessageListGet(msg: MsgEntFilter, sigAcceptor: ISigAcceptor<SigStarMessageList>)
          {
            CallFactory.rpc.create(SigStarMessageList::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "starMessageListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun userAvatarBulkGet(entId: EntId, msg: MsgUserAvatarBulkGet, sigAcceptor: ISigAcceptor<SigBulkUserAvatar>)
          {
      ...
      fun userNotificationListGet(msg: MsgUserNotificationList, sigAcceptor: ISigAcceptor<SigUserNotificationList>)
          {
            CallFactory.rpc.create(SigUserNotificationList::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "userNotificationListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun userNotificationMarkRead(msg: MsgUserNotificationId, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "userNotificationMarkRead")
              .sendBearerToken()
              .put(msg, sigAcceptor)
          }
      ...
      fun userNotificationRemove(msg: MsgUserNotificationId, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "userNotificationRemove")
              .sendBearerToken()
              .delete(msg, sigAcceptor)
          }
  }
