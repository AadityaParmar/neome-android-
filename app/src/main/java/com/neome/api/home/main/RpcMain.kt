  ...
  companion object
  {
    val SN: ServiceName = ServiceName.main
      ...
      fun groupMessageCandidateListGet(entId: EntId, sigAcceptor: ISigAcceptor<SigGroupMessageCandidateList>)
          {
            CallFactory.rpc.create(SigGroupMessageCandidateList::class.java, entId, SN, "groupMessageCandidateListGet")
              .sendBearerToken()
      ...
      fun linkPreviewGet(msg: MsgUrl, sigAcceptor: ISigAcceptor<SigLinkPreview>)
          {
            CallFactory.rpc.create(SigLinkPreview::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "linkPreviewGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun messageForwardCandidateListGet(entId: EntId, msg: MsgMessageForwardCandidateList, sigAcceptor: ISigAcceptor<SigChatCandidateMap>)
          {
            CallFactory.rpc.create(SigChatCandidateMap::class.java, entId, SN, "messageForwardCandidateListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun userMessageCandidateListGet(sigAcceptor: ISigAcceptor<SigUserMessageCandidateList>)
          {
            CallFactory.rpc.create(SigUserMessageCandidateList::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "userMessageCandidateListGet")
              .sendBearerToken()
              .get(null, sigAcceptor)
          }
  }
