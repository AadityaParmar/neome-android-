...
class WsocCli
{
  companion object
  {
    val SN: ServiceName = ServiceName.cli
      ...
      fun neoScriptCtxSet(entId: EntId, msg: MsgNeoScriptCtxSet, sigAcceptor: ISigAcceptor<SigNeoScriptPut>)
          {
      ...
      fun neoScriptGet(msg: MsgNeoScriptGet, sigAcceptor: ISigAcceptor<SigNeoScriptGet>)
          {
            CallFactory.wsoc.create(SigNeoScriptGet::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "neoScriptGet")
              .get(msg, sigAcceptor)
          }

      fun neoScriptPut(msg: MsgNeoScriptPut, sigAcceptor: ISigAcceptor<SigNeoScriptPut>)
          {
            CallFactory.wsoc.create(SigNeoScriptPut::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "neoScriptPut")
              .put(msg, sigAcceptor)
          }
  }
}