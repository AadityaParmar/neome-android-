  ...
  companion object
  {
    val SN: ServiceName = ServiceName.user
      ...
      fun accountCreate(msg: MsgAccountCreate, sigAcceptor: ISigAcceptor<SigVerifyKey>)
          {
            CallFactory.rpc.create(SigVerifyKey::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "accountCreate")
              .sendRefreshToken()
      ...
      fun appVersionGet(msg: MsgAppVersion, sigAcceptor: ISigAcceptor<SigAppVersion>)
          {
            CallFactory.rpc.create(SigAppVersion::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "appVersionGet")
              .get(msg, sigAcceptor)
          }

      fun callerDeviceGet(msg: MsgDeviceGet, sigAcceptor: ISigAcceptor<SigCallerDevice>)
          {
            CallFactory.rpc.create(SigCallerDevice::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "callerDeviceGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun callerLocationPut(msg: MsgCallerLocationPut, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "callerLocationPut")
              .sendRefreshToken()
              .put(msg, sigAcceptor)
          }
      ...
      fun callerSettingGet(msg: MsgVersion, sigAcceptor: ISigAcceptor<SigUserSetting>)
          {
            CallFactory.rpc.create(SigUserSetting::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "callerSettingGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun callerSettingPut(msg: MsgCallerSettingPut, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "callerSettingPut")
              .sendBearerToken()
              .put(msg, sigAcceptor)
          }
      ...
      fun forgotPassword(msg: MsgForgotPassword, sigAcceptor: ISigAcceptor<SigVerifyKey>)
          {
            CallFactory.rpc.create(SigVerifyKey::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "forgotPassword")
              .patch(msg, sigAcceptor)
          }

      fun grantBearerToken(msg: MsgGrantBearerToken, sigAcceptor: ISigAcceptor<SigBearerToken>)
          {
            CallFactory.rpc.create(SigBearerToken::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "grantBearerToken")
              .sendRefreshToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun grantRefreshToken(sigAcceptor: ISigAcceptor<SigRefreshToken>)
          {
            CallFactory.rpc.create(SigRefreshToken::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "grantRefreshToken")
              .sendRefreshToken()
      ...
      fun qRCodeSignIn(msg: MsgQrCodeSignIn, sigAcceptor: ISigAcceptor<SigVerifyKey>)
          {
            CallFactory.rpc.create(SigVerifyKey::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "qRCodeSignIn")
              .sendRefreshToken()
              .post(msg, sigAcceptor)
          }
      ...
      fun qRCodeVerify(msg: MsgQrCodeVerify, sigAcceptor: ISigAcceptor<SigRefreshToken>)
          {
            CallFactory.rpc.create(SigRefreshToken::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "qRCodeVerify")
              .sendRefreshToken()
              .post(msg, sigAcceptor)
          }
      ...
      fun signInUserId(msg: MsgSignInUserId, sigAcceptor: ISigAcceptor<SigRefreshToken>)
          {
            CallFactory.rpc.create(SigRefreshToken::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "signInUserId")
              .sendRefreshToken()
              .post(msg, sigAcceptor)
          }
      ...
      fun socialSignIn(msg: MsgSocialSignIn, sigAcceptor: ISigAcceptor<SigRefreshToken>)
          {
            CallFactory.rpc.create(SigRefreshToken::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "socialSignIn")
              .sendRefreshToken()
              .post(msg, sigAcceptor)
          }
  }
