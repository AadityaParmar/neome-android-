...
class RpcExtn
{
  companion object
  {
    val SN: ServiceName = ServiceName.extn
      ...
      fun extnGstinDetailsGet(msg: MsgExtnGstinDetailsGet, sigAcceptor: ISigAcceptor<SigExtnGstinDetails>)
          {
            CallFactory.rpc.create(SigExtnGstinDetails::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "extnGstinDetailsGet")
              .get(msg, sigAcceptor)
          }
  }
}