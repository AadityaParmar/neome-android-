  ...
  companion object
  {
    val SN: ServiceName = ServiceName.deeplink
      ...
      fun deeplinkAction(msg: MsgDeeplinkCodeAction, sigAcceptor: ISigAcceptor<SigCallback>)
          {
            CallFactory.rpc.create(SigCallback::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "deeplinkAction")
              .sendRefreshToken()
      ...
      fun deeplinkDataGet(msg: MsgDeeplinkCode, sigAcceptor: ISigAcceptor<SigDeeplinkData>)
          {
            CallFactory.rpc.create(SigDeeplinkData::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "deeplinkDataGet")
              .sendRefreshToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun deeplinkHtmlGet(msg: MsgDeeplinkHtml, sigAcceptor: ISigAcceptor<SigDeeplinkHtml>)
          {
            CallFactory.rpc.create(SigDeeplinkHtml::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "deeplinkHtmlGet")
              .get(msg, sigAcceptor)
          }

      fun deeplinkPreviewGet(msg: MsgDeeplinkCode, sigAcceptor: ISigAcceptor<SigDeeplinkPreview>)
          {
            CallFactory.rpc.create(SigDeeplinkPreview::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "deeplinkPreviewGet")
              .get(msg, sigAcceptor)
          }
  }
}