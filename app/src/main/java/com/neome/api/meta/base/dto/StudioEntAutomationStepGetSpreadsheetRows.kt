...
interface StudioEntAutomationStepGetSpreadsheetRows : StudioEntAutomationStep
{
  ...
  val sortByFieldId: MetaIdField?
  val targetSpreadsheetFilterVarId: StudioValueVarIdCondition?
