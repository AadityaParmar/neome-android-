...
class RpcStore {
    companion object {
        ...
        fun storeAdminCallerGet(
            storeItemId: StoreItemId,
            sigAcceptor: ISigAcceptor<SigStoreAdminCaller>
        ) {
            CallFactory.rpc.create(
                SigStoreAdminCaller::class.java,
                storeItemId,
                SN,
                "storeAdminCallerGet"
            )
        ...
        fun storeAdminEditLockDetailGet(
            storeItemId: StoreItemId,
            msg: MsgVersion,
            ...
            CallFactory.rpc.create(
                ...
                storeItemId,
                SN,
                "storeAdminEditLockDetailGet"
            )
                .sendBearerToken()
                .get(msg, sigAcceptor)
        }

        fun storeAdminEditLockTransfer(
            storeItemId: StoreItemId,
            msg: MsgAdminId,
            sigAcceptor: ISigAcceptor<SigDone>
        ) {
        ...
        fun storeAdminUpdate(
            storeItemId: StoreItemId,
            msg: MsgStoreAdminUpdate,
            sigAcceptor: ISigAcceptor<SigDone>
        ) {
        ...
        fun storeItemEntMerge(
            msg: MsgStudioEntMerge,
            sigAcceptor: ISigAcceptor<SigStudioEntMerge>
        ) {
            CallFactory.rpc.create(
                SigStudioEntMerge::class.java,
                ApiPlus.ENT_ID_GLOBAL,
                SN,
                "storeItemEntMerge"
            )
        ...
        fun storeItemListGet(msg: MsgStoreFilters, sigAcceptor: ISigAcceptor<SigStoreItemListGet>) {
            CallFactory.rpc.create(
                SigStoreItemListGet::class.java,
                ApiPlus.ENT_ID_GLOBAL,
                SN,
                "storeItemListGet"
            )
