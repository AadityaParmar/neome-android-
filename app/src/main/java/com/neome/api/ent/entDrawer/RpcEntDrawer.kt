...
class RpcEntDrawer {
    companion object {
        ...
        fun entAvatarUserGet(
            entId: EntId,
            msg: MsgVersion,
            sigAcceptor: ISigAcceptor<SigEntAvatarUser>
        ) {
        ...
        fun entCallerVariableUpdate(
            entId: EntId,
            msg: MsgEntVariableUpdate,
        ...
        fun entDeployListGet(sigAcceptor: ISigAcceptor<SigEntDeployListGet>) {
            CallFactory.rpc.create(
                SigEntDeployListGet::class.java,
        ...
        fun entFreezeGroupListGet(
            msg: MsgEntFilter,
            sigAcceptor: ISigAcceptor<SigEntFreezeGroupListGet>
        ) {
            CallFactory.rpc.create(
                SigEntFreezeGroupListGet::class.java,
                ApiPlus.ENT_ID_GLOBAL,
                SN,
