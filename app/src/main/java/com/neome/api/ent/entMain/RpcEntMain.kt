...
class RpcEntMain
{
  companion object
  {
    val SN: ServiceName = ServiceName.entMain
      ...
      fun automationExecutionStatusGet(entId: EntId, msg: MsgAutomationExecutionId, sigAcceptor: ISigAcceptor<SigAutomationState>)
          {
            CallFactory.rpc.create(SigAutomationState::class.java, entId, SN, "automationExecutionStatusGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun buttonWorkflowExecute(entId: EntId, msg: MsgButtonWorkflowExecute, sigAcceptor: ISigAcceptor<SigDone>)
          {
      ...
      fun entAutomationResume(entId: EntId, msg: MsgAutomationExecutionId, sigAcceptor: ISigAcceptor<SigDone>)
          {
      ...
      fun entAutomationStateInfoListGet(entId: EntId, msg: MsgAutomationStateInfoList, sigAcceptor: ISigAcceptor<SigAutomationStateInfoList>)
          {
            CallFactory.rpc.create(SigAutomationStateInfoList::class.java, entId, SN, "entAutomationStateInfoListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun entAutomationStateRemove(entId: EntId, msg: MsgAutomationExecutionIdNoVersion, sigAcceptor: ISigAcceptor<SigDone>)
          {
      ...
      fun entExportExcel(msg: MsgEntExportExcel, sigAcceptor: ISigAcceptor<SigTaskId>)
          {
            CallFactory.rpc.create(SigTaskId::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "entExportExcel")
              .sendRefreshToken()
              .post(msg, sigAcceptor)
          }
      ...
      fun entFormExport(msg: MsgEntFormExport, sigAcceptor: ISigAcceptor<SigEntFormExport>)
          {
            CallFactory.rpc.create(SigEntFormExport::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "entFormExport")
              .sendRefreshToken()
              .post(msg, sigAcceptor)
          }

      fun entFormMappingResultGet(entId: EntId, msg: MsgFormMappingResultGet, sigAcceptor: ISigAcceptor<SigFormMappingResultGet>)
          {
            CallFactory.rpc.create(SigFormMappingResultGet::class.java, entId, SN, "entFormMappingResultGet")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }

      fun entFormResultCalc(entId: EntId, msg: MsgFormResultCalc, sigAcceptor: ISigAcceptor<SigFormValue>)
          {
      ...
      fun entInvitationListGet(sigAcceptor: ISigAcceptor<SigEntInvitationList>)
          {
            CallFactory.rpc.create(SigEntInvitationList::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "entInvitationListGet")
              .sendBearerToken()
              .get(null, sigAcceptor)
          }
      ...
      fun entPromptActionsGet(entId: EntId, msg: MsgPromptActionsGet, sigAcceptor: ISigAcceptor<SigPromptActions>)
          {
      ...
      fun entPromptExecutorTest(msg: MsgPromptTest, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "entPromptExecutorTest")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }

      fun entReportOutputFormGet(entId: EntId, msg: MsgReportOutputFormGet, sigAcceptor: ISigAcceptor<SigReportOutputFormGet>)
          {
            CallFactory.rpc.create(SigReportOutputFormGet::class.java, entId, SN, "entReportOutputFormGet")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }
      ...
      fun entSpreadsheetEditorShare(entId: EntId, msg: MsgSpreadsheetEditorShare, sigAcceptor: ISigAcceptor<SigUrl>)
          {
      ...
      fun entSpreadsheetInsertShare(entId: EntId, msg: MsgSpreadsheetInsertShare, sigAcceptor: ISigAcceptor<SigUrl>)
          {
      ...
      fun entSpreadsheetRowShare(entId: EntId, msg: MsgSpreadsheetRowShare, sigAcceptor: ISigAcceptor<SigUrl>)
          {
      ...
      fun entUserAvatarListGet(entId: EntId, msg: MsgVersion, sigAcceptor: ISigAcceptor<SigEntUserAvatarListGet>)
          {
            CallFactory.rpc.create(SigEntUserAvatarListGet::class.java, entId, SN, "entUserAvatarListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun entVarSeqIncr(entId: EntId, msg: MsgEntVarSeqIncr, sigAcceptor: ISigAcceptor<SigEntVarSeq>)
          {
      ...
      fun spreadsheetBulkRowCommentCountGet(entId: EntId, msg: MsgSpreadsheetBulkRowCommentCountGet, sigAcceptor: ISigAcceptor<SigSpreadsheetBulkRowCommentCount>)
          {
            CallFactory.rpc.create(SigSpreadsheetBulkRowCommentCount::class.java, entId, SN, "spreadsheetBulkRowCommentCountGet")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }

      fun spreadsheetBulkRowGet(entId: EntId, msg: MsgSpreadsheetBulkRowGet, sigAcceptor: ISigAcceptor<SigSpreadsheetBulkRowGet>)
          {
            CallFactory.rpc.create(SigSpreadsheetBulkRowGet::class.java, entId, SN, "spreadsheetBulkRowGet")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }

      fun spreadsheetBulkRowInsert(entId: EntId, msg: MsgSpreadsheetBulkRowInsert, sigAcceptor: ISigAcceptor<SigSpreadsheetBulkRowInsert>)
          {
            CallFactory.rpc.create(SigSpreadsheetBulkRowInsert::class.java, entId, SN, "spreadsheetBulkRowInsert")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }

      fun spreadsheetBulkRowRemove(entId: EntId, msg: MsgSpreadsheetRowRemove, sigAcceptor: ISigAcceptor<SigTaskId>)
          {
      ...
      fun spreadsheetBulkRowUpdate(entId: EntId, msg: MsgSpreadsheetBulkRowUpdate, sigAcceptor: ISigAcceptor<SigTaskId>)
          {
      ...
      fun spreadsheetClear(entId: EntId, msg: MsgSpreadsheetClear, sigAcceptor: ISigAcceptor<SigTaskId>)
          {
      ...
      fun spreadsheetHistoryFormValueGet(entId: EntId, msg: MsgSpreadsheetHistoryFormValue, sigAcceptor: ISigAcceptor<SigSpreadsheetHistoryFormValue>)
          {
            CallFactory.rpc.create(SigSpreadsheetHistoryFormValue::class.java, entId, SN, "spreadsheetHistoryFormValueGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun spreadsheetHistoryGet(entId: EntId, msg: MsgSpreadsheetHistoryGet, sigAcceptor: ISigAcceptor<SigAuditRecordList>)
          {
            CallFactory.rpc.create(SigAuditRecordList::class.java, entId, SN, "spreadsheetHistoryGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun spreadsheetPartitionSend(entId: EntId, msg: MsgSpreadsheetPartitionSend, sigAcceptor: ISigAcceptor<SigDone>)
          {
      ...
      fun spreadsheetRowCommentCountGet(entId: EntId, msg: MsgSpreadsheetRowCommentCountGet, sigAcceptor: ISigAcceptor<SigSpreadsheetRowCommentCount>)
          {
            CallFactory.rpc.create(SigSpreadsheetRowCommentCount::class.java, entId, SN, "spreadsheetRowCommentCountGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun spreadsheetRowExpiryGet(entId: EntId, msg: MsgSpreadsheetRowExpiryGet, sigAcceptor: ISigAcceptor<SigSpreadsheetRowExpiry>)
          {
            CallFactory.rpc.create(SigSpreadsheetRowExpiry::class.java, entId, SN, "spreadsheetRowExpiryGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun spreadsheetRowGet(entId: EntId, msg: MsgSpreadsheetRowGet, sigAcceptor: ISigAcceptor<SigSpreadsheetRow>)
          {
      ...
      fun spreadsheetRowMarkRead(entId: EntId, msg: MsgSpreadsheetRowMarkRead, sigAcceptor: ISigAcceptor<SigDone>)
          {
      ...
      fun spreadsheetRowRemove(entId: EntId, msg: MsgSpreadsheetRowRemove, sigAcceptor: ISigAcceptor<SigSpreadsheetRowRemove>)
          {
            CallFactory.rpc.create(SigSpreadsheetRowRemove::class.java, entId, SN, "spreadsheetRowRemove")
              .sendBearerToken()
              .delete(msg, sigAcceptor)
          }

      fun spreadsheetRowSend(entId: EntId, msg: MsgSpreadsheetRowSend, sigAcceptor: ISigAcceptor<SigSpreadsheetRowSend>)
          {
            CallFactory.rpc.create(SigSpreadsheetRowSend::class.java, entId, SN, "spreadsheetRowSend")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }

      fun spreadsheetRowUpdate(entId: EntId, msg: MsgSpreadsheetRowUpdate, sigAcceptor: ISigAcceptor<SigDone>)
          {
      ...
      fun spreadsheetRowsPageGet(entId: EntId, msg: MsgSpreadsheetRowsPageGet, sigAcceptor: ISigAcceptor<SigSpreadsheetRowsPage>)
          {
            CallFactory.rpc.create(SigSpreadsheetRowsPage::class.java, entId, SN, "spreadsheetRowsPageGet")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }

      fun userActionExecute(entId: EntId, msg: MsgUserActionExecute, sigAcceptor: ISigAcceptor<SigUserActionResult>)
          {
      ...
      fun workflowExecute(entId: EntId, msg: MsgWorkflowExecute, sigAcceptor: ISigAcceptor<SigDone>)
          {
      ...
      fun workflowExecutionParamUpdate(entId: EntId, msg: MsgWorkflowExecutionParamUpdate, sigAcceptor: ISigAcceptor<SigDone>)
          {
      ...
      fun workflowExecutionResume(entId: EntId, msg: MsgWorkflowExecutionResume, sigAcceptor: ISigAcceptor<SigDone>)
          {
      ...
      fun workflowExecutionStateGet(entId: EntId, msg: MsgWorkflowExecutionId, sigAcceptor: ISigAcceptor<SigWorkflowExecutionState>)
          {
            CallFactory.rpc.create(SigWorkflowExecutionState::class.java, entId, SN, "workflowExecutionStateGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun workflowExecutionStateListGet(entId: EntId, msg: MsgWorkflowExecutionStateList, sigAcceptor: ISigAcceptor<SigWorkflowExecutionStateList>)
          {
            CallFactory.rpc.create(SigWorkflowExecutionStateList::class.java, entId, SN, "workflowExecutionStateListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun workflowExecutionStateRemove(entId: EntId, msg: MsgWorkflowExecutionIdNoVersion, sigAcceptor: ISigAcceptor<SigDone>)
          {
