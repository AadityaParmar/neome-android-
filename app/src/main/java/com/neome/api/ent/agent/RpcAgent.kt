  ...
  companion object
  {
    val SN: ServiceName = ServiceName.agent
      ...
      fun agentEntSpreadsheetDataGet(entId: EntId, msg: MsgEntSpreadsheetData, sigAcceptor: ISigAcceptor<SigEntSpreadsheetData>)
          {
            CallFactory.rpc.create(SigEntSpreadsheetData::class.java, entId, SN, "agentEntSpreadsheetDataGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun agentEntSpreadsheetPartitionRowIdListGet(entId: EntId, msg: MsgEntSpreadsheetPartitionRowIdList, sigAcceptor: ISigAcceptor<SigEntSpreadsheetPartitionRowIdList>)
          {
            CallFactory.rpc.create(SigEntSpreadsheetPartitionRowIdList::class.java, entId, SN, "agentEntSpreadsheetPartitionRowIdListGet")
              .sendBearerToken()
      ...
      fun agentEntSpreadsheetStateGet(entId: EntId, msg: MsgEntSpreadsheetState, sigAcceptor: ISigAcceptor<SigEntSpreadsheetState>)
          {
            CallFactory.rpc.create(SigEntSpreadsheetState::class.java, entId, SN, "agentEntSpreadsheetStateGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun agentEntUserImport(entId: EntId, msg: MsgAgentEntUserImport, sigAcceptor: ISigAcceptor<SigAgentEntUserImport>)
          {
            CallFactory.rpc.create(SigAgentEntUserImport::class.java, entId, SN, "agentEntUserImport")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }

      fun agentEntUserListGet(entId: EntId, msg: MsgVersion, sigAcceptor: ISigAcceptor<SigAgentEntUserList>)
          {
            CallFactory.rpc.create(SigAgentEntUserList::class.java, entId, SN, "agentEntUserListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun guaranteedRequestListGet(msg: MsgGuaranteedRequestQueueId, sigAcceptor: ISigAcceptor<SigGuaranteedRequestListGet>)
          {
            CallFactory.rpc.create(SigGuaranteedRequestListGet::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "guaranteedRequestListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun guaranteedRequestMarkRead(msg: MsgGuaranteedRequestQueueIdOffset, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "guaranteedRequestMarkRead")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }
      ...
      fun pluginApiResponseAccept(msg: MsgPluginApiResponseAccept, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "pluginApiResponseAccept")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }
      ...
      fun pluginWebhookResponseAccept(msg: MsgPluginWebhookResponseAccept, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "pluginWebhookResponseAccept")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }
  }
