  ...
  companion object
  {
    val SN: ServiceName = ServiceName.entMain
      ...
      fun automationExecutionStatusGet(entId: EntId, msg: MsgAutomationExecutionId, sigAcceptor: ISigAcceptor<SigAutomationState>)
          {
            CallFactory.wsoc.create(SigAutomationState::class.java, entId, SN, "automationExecutionStatusGet")
              .get(msg, sigAcceptor)
          }
      ...
      fun entAutomationStateInfoListGet(entId: EntId, msg: MsgAutomationStateInfoList, sigAcceptor: ISigAcceptor<SigAutomationStateInfoList>)
          {
            CallFactory.wsoc.create(SigAutomationStateInfoList::class.java, entId, SN, "entAutomationStateInfoListGet")
              .get(msg, sigAcceptor)
          }
      ...
      fun entFormMappingResultGet(entId: EntId, msg: MsgFormMappingResultGet, sigAcceptor: ISigAcceptor<SigFormMappingResultGet>)
          {
            CallFactory.wsoc.create(SigFormMappingResultGet::class.java, entId, SN, "entFormMappingResultGet")
              .post(msg, sigAcceptor)
          }
      ...
      fun entPromptExecutorTest(msg: MsgPromptTest, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.wsoc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "entPromptExecutorTest")
              .post(msg, sigAcceptor)
          }
      ...
      fun spreadsheetBulkRowCommentCountGet(entId: EntId, msg: MsgSpreadsheetBulkRowCommentCountGet, sigAcceptor: ISigAcceptor<SigSpreadsheetBulkRowCommentCount>)
          {
            CallFactory.wsoc.create(SigSpreadsheetBulkRowCommentCount::class.java, entId, SN, "spreadsheetBulkRowCommentCountGet")
              .post(msg, sigAcceptor)
          }

      fun spreadsheetBulkRowGet(entId: EntId, msg: MsgSpreadsheetBulkRowGet, sigAcceptor: ISigAcceptor<SigSpreadsheetBulkRowGet>)
          {
            CallFactory.wsoc.create(SigSpreadsheetBulkRowGet::class.java, entId, SN, "spreadsheetBulkRowGet")
              .post(msg, sigAcceptor)
          }
      ...
      fun spreadsheetRowCommentCountGet(entId: EntId, msg: MsgSpreadsheetRowCommentCountGet, sigAcceptor: ISigAcceptor<SigSpreadsheetRowCommentCount>)
          {
            CallFactory.wsoc.create(SigSpreadsheetRowCommentCount::class.java, entId, SN, "spreadsheetRowCommentCountGet")
              .get(msg, sigAcceptor)
          }

      fun spreadsheetRowExpiryGet(entId: EntId, msg: MsgSpreadsheetRowExpiryGet, sigAcceptor: ISigAcceptor<SigSpreadsheetRowExpiry>)
          {
            CallFactory.wsoc.create(SigSpreadsheetRowExpiry::class.java, entId, SN, "spreadsheetRowExpiryGet")
              .get(msg, sigAcceptor)
          }
      ...
      fun spreadsheetRowRemove(entId: EntId, msg: MsgSpreadsheetRowRemove, sigAcceptor: ISigAcceptor<SigSpreadsheetRowRemove>)
          {
            CallFactory.wsoc.create(SigSpreadsheetRowRemove::class.java, entId, SN, "spreadsheetRowRemove")
              .delete(msg, sigAcceptor)
          }

      fun spreadsheetRowSend(entId: EntId, msg: MsgSpreadsheetRowSend, sigAcceptor: ISigAcceptor<SigSpreadsheetRowSend>)
          {
            CallFactory.wsoc.create(SigSpreadsheetRowSend::class.java, entId, SN, "spreadsheetRowSend")
              .post(msg, sigAcceptor)
          }
