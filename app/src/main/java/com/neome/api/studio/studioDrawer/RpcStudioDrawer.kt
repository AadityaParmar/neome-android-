...
class RpcStudioDrawer
{
  companion object
  {
    val SN: ServiceName = ServiceName.studioDrawer
      ...
      fun artifactDuplicate(artifactId: ArtifactId, msg: MsgArtifactDuplicate, sigAcceptor: ISigAcceptor<SigDone>)
          {
      ...
      fun studioArtifactAvatarListGet(msg: MsgStudioArtifactAvatarListGet, sigAcceptor: ISigAcceptor<SigStudioArtifactAvatarList>)
          {
            CallFactory.rpc.create(SigStudioArtifactAvatarList::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "studioArtifactAvatarListGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
      ...
      fun studioDeployedArtifactListGet(sigAcceptor: ISigAcceptor<SigStudioDeployedArtifactList>)
          {
            CallFactory.rpc.create(SigStudioDeployedArtifactList::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "studioDeployedArtifactListGet")
              .sendBearerToken()
      ...
      fun studioEntCreate(msg: MsgStudioEntCreate, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "studioEntCreate")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }

      fun studioEntDeploy(entId: EntId, msg: MsgStudioEntDeploy, sigAcceptor: ISigAcceptor<SigStudioEntDeploy>)
          {
      ...
      fun studioEntMergeTest(msg: MsgStudioEntMergeTest, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "studioEntMergeTest")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }

      fun studioEntPartMerge(entId: EntId, msg: MsgStudioEntPartMerge, sigAcceptor: ISigAcceptor<SigDone>)
          {
      ...
      fun studioPluginAvatarGet(pluginBundleId: PluginBundleId, msg: MsgVersion, sigAcceptor: ISigAcceptor<SigStudioPluginAvatar>)
          {
            CallFactory.rpc.create(SigStudioPluginAvatar::class.java, pluginBundleId, SN, "studioPluginAvatarGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun studioPluginBundleGet(pluginBundleId: PluginBundleId, msg: MsgVersion, sigAcceptor: ISigAcceptor<SigStudioPluginBundle>)
          {
            CallFactory.rpc.create(SigStudioPluginBundle::class.java, pluginBundleId, SN, "studioPluginBundleGet")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }

      fun studioPluginBundleRemove(pluginBundleId: PluginBundleId, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, pluginBundleId, SN, "studioPluginBundleRemove")
              .sendBearerToken()
              .delete(null, sigAcceptor)
          }
      ...
      fun studioPluginCreate(msg: MsgStudioPluginCreate, sigAcceptor: ISigAcceptor<SigDone>)
          {
            CallFactory.rpc.create(SigDone::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "studioPluginCreate")
              .sendBearerToken()
              .post(msg, sigAcceptor)
          }
      ...
      fun studioSearch(msg: MsgStudioSearch, sigAcceptor: ISigAcceptor<SigStudioSearch>)
          {
            CallFactory.rpc.create(SigStudioSearch::class.java, ApiPlus.ENT_ID_GLOBAL, SN, "studioSearch")
              .sendBearerToken()
              .get(msg, sigAcceptor)
          }
  }
