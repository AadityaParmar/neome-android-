...
import com.neome.java.api.meta.base.Types.EnumDefnTableLayoutTheme;
...
public class DefnLayoutGridTable extends DefnLayoutGrid
{
  @Nullable
  ...
  @Nullable
  public DefnStudioMapOfTableFooter footer;

  @Nullable
  public MetaIdField[] freezeFieldIdSet;

  @Nullable
  public DefnStudioMapOfTableHeader header;
  ...
  @Nullable
  public DefnMapOfTableStyle styleMap;
