...
public class StudioEntAutomationStepUpdateUser extends StudioEntAutomationStep
{
  @Nullable
  ...
  @Nullable
  public MetaIdField userActivateFieldId;

  @Nullable
  public MetaIdVar userActivateVarId;

  @Nullable
  public MetaIdField userIdFieldId;
